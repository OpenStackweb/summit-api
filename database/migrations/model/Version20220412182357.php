...
SELECT SelectionPlan.ID, SummitEventType.ID FROM SelectionPlan, SummitEventType 
WHERE SummitEventType.ClassName = 'PresentationType' AND SummitEventType.SummitID = SelectionPlan.ID AND NOT EXISTS (
    SELECT 1 FROM SelectionPlan_SummitEventTypes 
    WHERE SelectionPlan_SummitEventTypes.SelectionPlanID = SelectionPlan.ID 
