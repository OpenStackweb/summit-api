...
final class SummitValidationRulesFactory extends AbstractValidationRulesFactory
{
    ...
    public static function buildForAdd(array $payload = []): array
    {
        return [
            ...
            'end_date' => 'required_with:start_date|date_format:U|epoch_seconds|after_or_equal:start_date',
            'registration_begin_date' => 'nullable|date_format:U|epoch_seconds',
            'registration_end_date' => 'nullable|required_with:registration_begin_date|date_format:U|epoch_seconds|after_or_equal:registration_begin_date',
            'start_showing_venues_date' => 'nullable|date_format:U|epoch_seconds|before_or_equal:start_date',
            'schedule_start_date' => 'nullable|date_format:U|epoch_seconds|after_or_equal:start_date|before_or_equal:end_date',
            ...
            'meeting_room_booking_start_time' => 'nullable|date_format:U|epoch_seconds',
            'meeting_room_booking_end_time' => 'nullable|required_with:meeting_room_booking_start_time|date_format:U|epoch_seconds|after_or_equal:meeting_room_booking_start_time',
            ...
            'begin_allow_booking_date' => 'nullable|date_format:U|epoch_seconds',
            'end_allow_booking_date' => 'nullable|required_with:begin_allow_booking_date|date_format:U|epoch_seconds|after_or_equal:begin_allow_booking_date',
            'reassign_ticket_till_date' => 'nullable|date_format:U|epoch_seconds',
