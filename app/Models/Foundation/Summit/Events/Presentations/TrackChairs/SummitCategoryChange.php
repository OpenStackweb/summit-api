...
class SummitCategoryChange extends SilverstripeBaseModel {
  ...
  public function getNiceStatus(): string {
    if ($this->status == ISummitCategoryChangeStatus::Pending) {
      return "Pending";
    }
    if ($this->status == ISummitCategoryChangeStatus::Rejected) {
      return "Rejected";
    }
    if ($this->status == ISummitCategoryChangeStatus::Approved) {
      return "Approved";
    }
    return "Pending";
  }
