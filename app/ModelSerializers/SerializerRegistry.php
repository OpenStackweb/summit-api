...
final class SerializerRegistry {
  ...
  private function __construct() {
    ...
    $this->registry["SummitSponsorExtraQuestionType"] =
      SummitSponsorExtraQuestionTypeSerializer::class;
    ...
    $this->registry["SummitAdministratorPermissionGroup"] =
      SummitAdministratorPermissionGroupSerializer::class;
    ...
    $this->registry["SummitSelectionPlanExtraQuestionType"] =
      SummitSelectionPlanExtraQuestionTypeSerializer::class;
    $this->registry["AssignedSelectionPlanExtraQuestionType"] =
      AssignedSelectionPlanExtraQuestionTypeSerializer::class;
    ...
    $this->registry["PrivatePresentationCategoryGroup"] =
      PrivatePresentationCategoryGroupSerializer::class;
    $this->registry["Tag"] = TagSerializer::class;
    $this->registry["Language"] = LanguageSerializer::class;
    $this->registry["PresentationExtraQuestionAnswer"] =
      PresentationExtraQuestionAnswerSerializer::class;
    // track questions
    ...
    $this->registry["TrackTextBoxQuestionTemplate"] =
      TrackSingleValueTemplateQuestionSerializer::class;
    $this->registry["TrackCheckBoxQuestionTemplate"] =
      TrackSingleValueTemplateQuestionSerializer::class;
    $this->registry["TrackDropDownQuestionTemplate"] =
      TrackDropDownQuestionTemplateSerializer::class;
    $this->registry["TrackCheckBoxListQuestionTemplate"] =
      TrackMultiValueQuestionTemplateSerializer::class;
    $this->registry["TrackRadioButtonListQuestionTemplate"] =
      TrackMultiValueQuestionTemplateSerializer::class;
    $this->registry["TrackLiteralContentQuestionTemplate"] =
      TrackLiteralContentQuestionTemplateSerializer::class;
    ...
    $this->registry["SummitSelectedPresentationList"] =
      SummitSelectedPresentationListSerializer::class;
    ...
    $this->registry["PresentationTrackChairRatingType"] =
      PresentationTrackChairRatingTypeSerializer::class;
    $this->registry["PresentationTrackChairScoreType"] =
      PresentationTrackChairScoreTypeSerializer::class;
    ...
    $this->registry["RSVPSingleValueTemplateQuestion"] =
      RSVPSingleValueTemplateQuestionSerializer::class;
    $this->registry["RSVPTextBoxQuestionTemplate"] =
      RSVPSingleValueTemplateQuestionSerializer::class;
    $this->registry["RSVPTextAreaQuestionTemplate"] =
      RSVPSingleValueTemplateQuestionSerializer::class;
    $this->registry["RSVPLiteralContentQuestionTemplate"] =
      RSVPLiteralContentQuestionTemplateSerializer::class;
    $this->registry["RSVPMemberEmailQuestionTemplate"] =
      RSVPSingleValueTemplateQuestionSerializer::class;
    $this->registry["RSVPMemberFirstNameQuestionTemplate"] =
      RSVPSingleValueTemplateQuestionSerializer::class;
    $this->registry["RSVPMemberLastNameQuestionTemplate"] =
      RSVPSingleValueTemplateQuestionSerializer::class;

    $this->registry["RSVPCheckBoxListQuestionTemplate"] =
      RSVPMultiValueQuestionTemplateSerializer::class;
    $this->registry["RSVPRadioButtonListQuestionTemplate"] =
      RSVPMultiValueQuestionTemplateSerializer::class;
    ...
    $this->registry["PresentationSpeakerSummitAssistanceConfirmationRequest"] =
      PresentationSpeakerSummitAssistanceConfirmationRequestSerializer::class;
    $this->registry["SummitRegistrationDiscountCodeTicketTypeRule"] =
      SummitRegistrationDiscountCodeTicketTypeRuleSerializer::class;

    $this->registry["AssignedPromoCodeSpeaker"] = AssignedPromoCodeSpeakerSerializer::class;
    $this->registry["SummitRegistrationFeedMetadata"] =
      SummitRegistrationFeedMetadataSerializer::class;
    ...
    $this->registry["SummitOrderExtraQuestionAnswer"] =
      SummitOrderExtraQuestionAnswerSerializer::class;
    ...
    $this->registry["SummitAttendeeTicket"] = [
      ...
      ISummitAttendeeTicketSerializerTypes::PublicEdition =>
        PublicEditionSummitAttendeeTicketSerializer::class,
      ISummitAttendeeTicketSerializerTypes::GuestEdition =>
        GuestEditionSummitAttendeeTicketSerializer::class,
      self::SerializerType_CSV => SummitAttendeeTicketCSVSerializer::class,
    ];

    // refunds requests
    $this->registry["SummitAttendeeTicketRefundRequest"] =
      SummitAttendeeTicketRefundRequestSerializer::class;
    ...
    $this->registry["SponsorBadgeScanExtraQuestionAnswer"] =
      SponsorBadgeScanExtraQuestionAnswerSerializer::class;
    ...
    $this->registry["ScheduledSummitLocationBanner"] =
      ScheduledSummitLocationBannerSerializer::class;
    $this->registry["SummitBookableVenueRoom"] = SummitBookableVenueRoomSerializer::class;
    $this->registry["SummitBookableVenueRoomAttributeType"] =
      SummitBookableVenueRoomAttributeTypeSerializer::class;
    $this->registry["SummitBookableVenueRoomAttributeValue"] =
      SummitBookableVenueRoomAttributeValueSerializer::class;
    $this->registry["SummitBookableVenueRoomAvailableSlot"] =
      SummitBookableVenueRoomAvailableSlotSerializer::class;
    ...
    $this->registry["ChatTeamPushNotificationMessage"] =
      ChatTeamPushNotificationMessageSerializer::class;
    ...
    $this->registry["OpenStackImplementationApiCoverage"] =
      OpenStackImplementationApiCoverageSerializer::class;
    ...
    $this->registry["SummitProposedScheduleSummitEvent"] =
      SummitProposedScheduleSummitEventSerializer::class;
    $this->registry["SummitProposedScheduleAllowedLocation"] =
      SummitProposedScheduleAllowedLocationSerializer::class;
    $this->registry["SummitProposedScheduleAllowedDay"] =
      SummitProposedScheduleAllowedDaySerializer::class;
    ...
    if (is_array($serializer_class)) {
      ...
      if (!isset($serializer_class[$type])) {
        throw new \InvalidArgumentException(
          sprintf("Serializer not found for %s , type %s", $class, $type),
        );
      }
...
final class SerializerDecorator implements IModelSerializer {
  ...
  public function __construct(
    IModelSerializer $serializer_imp,
    array $pre_hooks = [],
    array $post_hooks = [],
  ) {
  ...
  public function serialize(
    ...
    foreach ($this->pre_hooks as $hook) {
      ...
      [$expand, $fields, $relations, $params] = call_user_func(
        $expand,
        $fields,
        $relations,
        $params,
