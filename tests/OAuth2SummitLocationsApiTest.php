...
final class OAuth2SummitLocationsApiTest extends ProtectedApiTestCase {
  ...
  public function testGetCurrentSummitLocationsByClassNameVenueORAirport($summit_id = 24) {
    $params = [
      ...
      "filter" => [
        "class_name==" .
        \models\summit\SummitVenue::ClassName .
        ",class_name==" .
        \models\summit\SummitAirport::ClassName,
      ],
    ];
  ...
  public function testGetCurrentSummitLocationsByClassHotels($summit_id = 25) {
    $params = [
      ...
      "page" => 1,
      "per_page" => 100,
      "filter" => ["class_name==" . \models\summit\SummitHotel::ClassName],
    ];
  ...
  public function testAddLocationBanner($summit_id = 23, $location_id = 315) {
    ...
    $data = [
      ...
      "enabled" => true,
      "class_name" =>
        \App\Models\Foundation\Summit\Locations\Banners\SummitLocationBanner::ClassName,
    ];
  ...
  public function testAddLocationScheduleBanner($summit_id = 23, $location_id = 315) {
    ...
    $data = [
      ...
      "enabled" => true,
      "class_name" =>
        \App\Models\Foundation\Summit\Locations\Banners\ScheduledSummitLocationBanner::ClassName,
  ...
  public function testSummitGetBookableRoomsFilterDiffValuesSameColumn($summit_id = 6) {
    $params = [
      ...
      "filter" => ["availability_day==1579086000", "attribute==", "capacity>=1"],
    ];
  ...
  public function testSummitGetBookableRoomAvailability(
    $summit_id = 6,
    $room_id = 20,
    $day = 1579172400,
  ) {
  ...
  public function testAddBookableRoomOnFloor($summit_id = 27) {
    ...
    $this->assertTrue($venues->count() > 0);
    $venue = $venues->first();
    if (!$venue instanceof \models\summit\SummitVenue) {
      return null;
    }
