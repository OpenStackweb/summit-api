...
class SummitTicketRefundRequestOwner extends AbstractSummitEmailJob {
  ...
  public function __construct(
    ...
    SummitAttendeeTicketRefundRequest $request = null,
  ) {
    $payload = [];
    ...
    $payload[IMailTemplatesConstants::ticket_refund_amount] = !is_null($request)
      ? FormatUtils::getNiceFloat($request->getRefundedAmount())
      : "";
    $payload[IMailTemplatesConstants::ticket_taxes_refund_amount] = !is_null($request)
      ? FormatUtils::getNiceFloat($request->getTaxesRefundedAmount())
      : "";
    $payload[IMailTemplatesConstants::ticket_total_refund_amount] = !is_null($request)
      ? FormatUtils::getNiceFloat($request->getTotalRefundedAmount())
      : "";
    $payload[IMailTemplatesConstants::ticket_refund_status] = !is_null($request)
      ? $request->getStatus()
      : "";
