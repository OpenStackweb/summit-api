 ...
 */
final class BuildDefaultPaymentGatewayProfileStrategy implements IBuildDefaultPaymentGatewayProfileStrategy
{

    public function build(string $application_type): ?PaymentGatewayProfile
    {
        try {
            Log::debug(sprintf("BuildDefaultPaymentGatewayProfileStrategy::build application_type %s", $application_type));
