  ...
  public static function build(array $data, $update = false) {
    ...
    switch ($data["class_name"]) {
      ...
      case SummitExternalLocation::ClassName:
        return array_merge(
          $base_rules,
          SummitExternalLocationValidationRulesFactory::build($data, $update),
        );
      case SummitVenueRoom::ClassName:
        return array_merge(
          $base_rules,
          SummitVenueRoomValidationRulesFactory::build($data, $update),
        );
        break;
      case SummitBookableVenueRoom::ClassName:
        return array_merge(
          $base_rules,
          SummitVenueBookableRoomValidationRulesFactory::build($data, $update),
        );
        break;
      default:
