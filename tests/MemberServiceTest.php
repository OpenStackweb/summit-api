...
final class MemberServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->old_external_id  = mt_rand(1000000000, 1499999999);
        $this->new_external_id  = mt_rand(1500000000, 1999999999);
    ...
    protected function tearDown(): void
    {
        try {
            ...
            foreach ([$this->old_external_id, $this->new_external_id] as $external_id) {
