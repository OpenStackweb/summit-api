 ...
 */
final class RSVPTemplateService extends AbstractService implements IRSVPTemplateService {
  /**
  ...
  public function deleteTemplate(Summit $summit, $template_id) {
    $this->tx_service->transaction(function () use ($summit, $template_id) {
      ...
      if (is_null($template)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.RSVPTemplateService.deleteTemplate.TemplateNotFound", [
            "summit_id" => $summit->getId(),
            "template_id" => $template_id,
          ]),
        );
  ...
  public function addQuestion(Summit $summit, $template_id, array $data) {
    return $this->tx_service->transaction(function () use ($summit, $template_id, $data) {
      ...
      if (is_null($template)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.RSVPTemplateService.addQuestion.TemplateNotFound", [
            "summit_id" => $summit->getId(),
            "template_id" => $template_id,
          ]),
        );
      ...
      if (!is_null($former_question)) {
        throw new ValidationException(
          trans("validation_errors.RSVPTemplateService.addQuestion.QuestionNameAlreadyExists", [
            "template_id" => $template_id,
            "name" => $data["name"],
          ]),
        );
  ...
  public function updateQuestion(Summit $summit, $template_id, $question_id, array $data) {
    return $this->tx_service->transaction(function () use (
      ...
      if (is_null($template)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.RSVPTemplateService.updateQuestion.TemplateNotFound", [
            "summit_id" => $summit->getId(),
            "template_id" => $template_id,
          ]),
        );
      ...
      if (is_null($question)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.RSVPTemplateService.updateQuestion.QuestionNotFound", [
            "summit_id" => $summit->getId(),
            "template_id" => $template_id,
  ...
  public function deleteQuestion(Summit $summit, $template_id, $question_id) {
    return $this->tx_service->transaction(function () use ($summit, $template_id, $question_id) {
      ...
      if (is_null($template)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.RSVPTemplateService.deleteQuestion.TemplateNotFound", [
            "summit_id" => $summit->getId(),
            "template_id" => $template_id,
          ]),
        );
      ...
      if (is_null($question)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.RSVPTemplateService.deleteQuestion.QuestionNotFound", [
            "summit_id" => $summit->getId(),
            "template_id" => $template_id,
            "question_id" => $question_id,
          ]),
  ...
  public function addQuestionValue($summit, $template_id, $question_id, $data) {
    return $this->tx_service->transaction(function () use (
      ...
      if (is_null($template)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.RSVPTemplateService.addQuestionValue.TemplateNotFound", [
            "summit_id" => $summit->getId(),
            "template_id" => $template_id,
          ]),
        );
      ...
      if (is_null($question)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.RSVPTemplateService.addQuestionValue.QuestionNotFound", [
            "summit_id" => $summit->getId(),
            "template_id" => $template_id,
            "question_id" => $question_id,
          ]),
      ...
      if (!is_null($former_value)) {
        throw new ValidationException(
          trans("validation_errors.RSVPTemplateService.addQuestionValue.ValueAlreadyExist", [
            "summit_id" => $summit->getId(),
            "template_id" => $template_id,
            "question_id" => $question_id,
            "value" => $data["value"],
  ...
  public function updateQuestionValue($summit, $template_id, $question_id, $value_id, $data) {
    return $this->tx_service->transaction(function () use (
      ...
      if (is_null($template)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.RSVPTemplateService.updateQuestionValue.TemplateNotFound", [
            "summit_id" => $summit->getId(),
            "template_id" => $template_id,
          ]),
        );
      ...
      if (is_null($question)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.RSVPTemplateService.updateQuestionValue.QuestionNotFound", [
            "summit_id" => $summit->getId(),
            "template_id" => $template_id,
            "question_id" => $question_id,
          ]),
      ...
      if (isset($data["value"])) {
        ...
        if (!is_null($former_value) && $former_value->getId() != $value_id) {
          throw new ValidationException(
            trans("validation_errors.RSVPTemplateService.updateQuestionValue.ValueAlreadyExist", [
              "summit_id" => $summit->getId(),
              "template_id" => $template_id,
              "question_id" => $question_id,
              "value" => $data["value"],
      ...
      if (is_null($value)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.RSVPTemplateService.updateQuestionValue.ValueNotFound", [
            "summit_id" => $summit->getId(),
            "template_id" => $template_id,
            "question_id" => $question_id,
            "value_id" => $value_id,
  ...
  public function deleteQuestionValue($summit, $template_id, $question_id, $value_id) {
    return $this->tx_service->transaction(function () use (
      ...
      if (is_null($template)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.RSVPTemplateService.deleteQuestionValue.TemplateNotFound", [
            "summit_id" => $summit->getId(),
            "template_id" => $template_id,
          ]),
        );
      ...
      if (is_null($question)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.RSVPTemplateService.deleteQuestionValue.QuestionNotFound", [
            "summit_id" => $summit->getId(),
            "template_id" => $template_id,
            "question_id" => $question_id,
          ]),
      ...
      if (is_null($value)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.RSVPTemplateService.deleteQuestionValue.ValueNotFound", [
            "summit_id" => $summit->getId(),
            "template_id" => $template_id,
            "question_id" => $question_id,
            "value_id" => $value_id,
