...
/**
 * Class Version20230720172326
 * @package Database\Migrations\Model
 */
final class Version20230720172326 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema): void
    {
        ...
        if($schema->hasTable("SummitOrder")) {
            $builder->table("SummitOrder", function (Table $table) {
                $table->dropColumn("CreditCardType");
                $table->dropColumn("CreditCard4Numbers");
            });
        }
    }
}
