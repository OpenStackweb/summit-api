...
final class OAuth2SummitApiTest extends ProtectedApiTestCase {
    ...
    $eventBriteMock
      ...
      ->andThrow(
        new ClientException(
          ...
          \Mockery::mock(\GuzzleHttp\Psr7\Response::class, ["getStatusCode" => 400]),
        ),
      );
  ...
  public function testGetCurrentSummitRegStats() {
    $params = [
      "id" => self::$summit->getId(),
      "filter" => ["start_date>=" . self::$summit->getBeginDate()->getTimestamp()],
    ];
  ...
  public function testGetAttendeesCheckinsOverTimeStats() {
    $params = [
      ...
      "page" => 1,
      "per_page" => 5,
      "filter" => ["start_date>=1688578812", "end_date<=1688924412"],
  ...
  public function testUpdateLeadReportSettings() {
    ...
    $this->assertEquals(
      $allowed_columns[SummitLeadReportSetting::AttendeeExtraQuestionsKey][0],
      $lead_report_settings->columns->attendee_extra_questions[0],
    );
  ...
  private function updateSummitRegSlugPrefix(
    $summit_id,
    $data,
