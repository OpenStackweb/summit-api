...
class SetupSponsorUsersServiceMessageBrokerCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $name = "setup_sponsor_users_service_message_broker";
     ...
     * @var string
     */
    protected $signature = "mq:setup_sponsor_users_service_message_broker {exchange_name} {exchange_type}";
     ...
     * @var string
     */
    protected $description = "Set up Sponsor Users Service rabbitmq exchange, queue and bindings";
    ...
    public function handle(): void
    {
        ...
        $queue_settings_path = "queue.connections.sponsor_users_sync_consumer";
