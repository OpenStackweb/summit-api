...
#[OA\Schema(
    schema: 'RemoteCloudsResponseSchema',
    allOf: [
        new OA\Schema(ref: '#/components/schemas/PublicOrPrivateCloudsResponseSchema'),
        new OA\Schema(
            type: 'object',
            properties: [
...
#[OA\Schema(
    schema: 'PaginatedRemoteCloudsResponseSchema',
    allOf: [
        new OA\Schema(ref: '#/components/schemas/PaginateDataSchemaResponse'),
        new OA\Schema(
            type: 'object',
            properties: [
                new OA\Property(
                    property: 'data',
                    type: 'array',
                    items: new OA\Items(ref: '#/components/schemas/RemoteCloudsResponseSchema')
                )
            ]
        )
    ]
