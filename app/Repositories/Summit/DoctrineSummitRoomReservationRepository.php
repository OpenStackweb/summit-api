...
final class DoctrineSummitRoomReservationRepository
  ...
  protected function getFilterMappings() {
    return [
      ...
      "room_id" => new DoctrineJoinFilterMapping("e.room", "r", "r.id :operator :value"),
      "room_name" => new DoctrineJoinFilterMapping("e.room", "r", "r.name :operator :value"),
      "venue_id" => new DoctrineJoinFilterMapping("r.venue", "v", "v.id :operator :value"),
      "owner_id" => new DoctrineJoinFilterMapping("e.owner", "o", "o.id :operator :value"),
      "owner_name" => new DoctrineJoinFilterMapping(
        "e.owner",
        "o",
        "LOWER(CONCAT(o.first_name, ' ', o.last_name)) :operator :value",
      ),
      "owner_email" => new DoctrineJoinFilterMapping("e.owner", "o", "o.email :operator :value"),
