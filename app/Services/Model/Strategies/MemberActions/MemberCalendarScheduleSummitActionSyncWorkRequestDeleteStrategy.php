 ...
 */
final class MemberCalendarScheduleSummitActionSyncWorkRequestDeleteStrategy implements
  ...
  public function process(AbstractCalendarSyncWorkRequest $request) {
    ...
    $pending_calendar_create_request = $this->queue_manager->getCalendarRequestFor(
    ...
    $pending_requests = $this->queue_manager->getPendingEventsForCalendar(
      $calendar_sync_info->getId(),
    );
