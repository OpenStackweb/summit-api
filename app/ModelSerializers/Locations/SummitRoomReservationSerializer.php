      ...
      foreach ($exp_expand as $relation) {
        ...
        switch ($relation) {
          case "room":
            ...
            $values["room"] = SerializerRegistry::getInstance()
              ->getSerializer($reservation->getRoom(), $this->getSerializerType($relation))
          ...
          case "owner":
            ...
            $values["owner"] = SerializerRegistry::getInstance()
              ->getSerializer($reservation->getOwner(), $this->getSerializerType($relation))
              ->serialize(AbstractSerializer::filterExpandByPrefix($expand, $relation));
            break;
        }
      }
