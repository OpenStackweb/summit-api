...
class AccessTokenServiceStub implements IAccessTokenService {
  ...
  public function get($token_value) {
    ...
    return AccessToken::createFromParams([
      ...
      "allowed_return_uris" =>
        "https://www.openstack.org/OpenStackIdAuthenticator,https://www.openstack.org/Security/login",
      "allowed_origins" => "",
...
abstract class ProtectedApiTestCase extends \Tests\BrowserKitTestCase {
  ...
  public function createApplication() {
    ...
    $geoCodingApiMock
      ->shouldReceive("getAddressInfo")
      ->andReturn(new AddressInfo("ADDRESS", "ADDRESS 1", "1234", "STATE", "CITY", "USA"))
      ->zeroOrMoreTimes();

    $geoCodingApiMock
      ->shouldReceive("getGeoCoordinates")
      ->andReturn(new GeoCoordinatesInfo("99.99", "99.99"))
      ->zeroOrMoreTimes();
