...
/**
 * Class Version20240513155541
 * @package Database\Migrations\Model
 */
class Version20240513155541 extends AbstractMigration
{
    /**
     * @param Schema $schema
...
SQL;
            ...
            $sql = <<<SQL
       update SummitScheduleConfig set TimeFormat = '12h' where TimeFormat IS NULL;
SQL;
            $this->addSql($sql);
        }
    }
