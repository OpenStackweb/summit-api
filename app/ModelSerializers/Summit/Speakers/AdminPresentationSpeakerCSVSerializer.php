...
final class AdminPresentationSpeakerCSVSerializer extends PresentationSpeakerBaseSerializer {
  ...
  public function serialize(
    ...
    if (in_array("accepted_presentations", $relations) && !is_null($summit)) {
      $accepted_presentations = $speaker->getAcceptedPresentations(
        $summit,
      ...
      $moderated_accepted_presentations = $speaker->getAcceptedPresentations(
        $summit,
      ...
      $all_accepted_presentations = array_merge(
        $accepted_presentations,
    ...
    if (in_array("alternate_presentations", $relations) && !is_null($summit)) {
      $alternate_presentations = $speaker->getAlternatePresentations(
        $summit,
        PresentationSpeaker::RoleSpeaker,
        false,
        [],
      ...
      $moderated_alternate_presentations = $speaker->getAlternatePresentations(
        $summit,
        PresentationSpeaker::RoleModerator,
        false,
        [],
      ...
      $all_alternate_presentations = array_merge(
        $alternate_presentations,
    ...
    if (in_array("rejected_presentations", $relations) && !is_null($summit)) {
      $rejected_presentations = $speaker->getRejectedPresentations(
        $summit,
        PresentationSpeaker::RoleSpeaker,
        false,
        [],
      ...
      $moderated_rejected_presentations = $speaker->getRejectedPresentations(
        $summit,
        PresentationSpeaker::RoleModerator,
        false,
        [],
      ...
      $all_rejected_presentations = array_merge(
        $rejected_presentations,
