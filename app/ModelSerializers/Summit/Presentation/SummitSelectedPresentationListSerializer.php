...
final class SummitSelectedPresentationListSerializer extends SilverStripeSerializer
{
    ...
    public function serialize($expand = null, array $fields = array(), array $relations = array(), array $params = array())
    {
        ...
        if (!$presentation_list instanceof SummitSelectedPresentationList) return [];
        ...
        if (in_array('interested_presentations', $relations) && $presentation_list->getListType() == SummitSelectedPresentationList::Individual) {
            $interested_presentations = [];
