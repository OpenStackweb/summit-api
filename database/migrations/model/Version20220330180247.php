...
/**
 * Class Version20220330180247
 * @package Database\Migrations\Model
 */
final class Version20220330180247 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema): void
    {
        ...
        if(!$schema->hasTable("SelectionPlan_SummitEventTypes")) {
            $builder->create('SelectionPlan_SummitEventTypes', function (Table $table) {
                $table->integer("ID", true, false);
                $table->primary("ID");

                $table->integer("SelectionPlanID")->setNotnull(true);
    ...
    {
        $builder = new Builder($schema);
        $builder->dropIfExists("SelectionPlan_SummitEventTypes");
    }
}
