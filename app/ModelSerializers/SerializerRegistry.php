...
final class SerializerDecorator implements IModelSerializer {
    ...
    public function serialize($expand = null, array $fields = [], array $relations = [], array $params = [])
    {
        ...
        if (!count(AbstractSerializer::getFirstLevelAllowedFields($relations))) $relations = array_merge($this->serializer_imp->getAllowedRelations());
        if(!count(AbstractSerializer::getFirstLevelAllowedFields($fields))) $fields = array_merge($fields, $this->serializer_imp->getAllowedFields());
