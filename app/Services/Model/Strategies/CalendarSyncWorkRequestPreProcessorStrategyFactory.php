 ...
 */
final class CalendarSyncWorkRequestPreProcessorStrategyFactory implements
  ICalendarSyncWorkRequestPreProcessorStrategyFactory {
  /**
    ...
    if ($request instanceof MemberEventScheduleSummitActionSyncWorkRequest) {
      switch ($request->getType()) {
        case AbstractCalendarSyncWorkRequest::TypeRemove:
          return new MemberEventScheduleSummitActionSyncWorkRequestDeleteStrategy(
            $queue_manager,
            $this->work_request_repository,
          );
        case AbstractCalendarSyncWorkRequest::TypeAdd:
          return new MemberEventScheduleSummitActionSyncWorkRequestAddStrategy(
            $queue_manager,
            $this->work_request_repository,
          );

        case AbstractCalendarSyncWorkRequest::TypeUpdate:
          return new MemberEventScheduleSummitActionSyncWorkRequestUpdateStrategy(
            $queue_manager,
            $this->work_request_repository,
          );
      }
