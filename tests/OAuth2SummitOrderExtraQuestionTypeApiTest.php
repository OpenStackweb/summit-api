...
final class OAuth2SummitOrderExtraQuestionTypeApiTest extends ProtectedApiTestCase {
  ...
  public function testAddExtraOrderQuestion() {
    ...
    $data = [
      ...
      "allowed_ticket_types" => [
        self::$default_ticket_type->getId(),
        self::$default_ticket_type_2->getId(),
      ],
  ...
  public function testAddSubQuestionRule412(): void {
    ...
    $data = [
      ...
      "answer_values_operator" =>
        ExtraQuestionTypeConstants::SubQuestionRuleAnswerValuesOperator_Or,
  ...
  public function testUpdateSubQuestionRule(): void {
    ...
    $data = [
      "visibility_condition" =>
        ExtraQuestionTypeConstants::SubQuestionRuleVisibilityCondition_NotEqual,
      "answer_values_operator" =>
    ...
    $this->assertTrue(!is_null($rule));
    $this->assertTrue(
      $rule->visibility_condition ===
        ExtraQuestionTypeConstants::SubQuestionRuleVisibilityCondition_NotEqual,
    );
    $this->assertTrue(
      $rule->answer_values_operator ===
        ExtraQuestionTypeConstants::SubQuestionRuleAnswerValuesOperator_And,
    );
  }
  ...
  public function testGetAttendeeAllowedExtraQuestions() {
    ...
    if (!$attendee instanceof SummitAttendee) {
      $this->fail("Not a valid attendee");
    }
  ...
  public function testGetAttendeeAllowedExtraQuestionsWith2SubquestionLevels() {
    ...
    $rule3->setVisibilityCondition(
      ExtraQuestionTypeConstants::SubQuestionRuleVisibilityCondition_Equal,
    );
    $rule3->setAnswerValuesOperator(
      ExtraQuestionTypeConstants::SubQuestionRuleAnswerValuesOperator_Or,
    );
    ...
    $this->assertCount(
      1,
      $questions->data[0]->sub_question_rules[0]->sub_question->sub_question_rules,
    ); //1 allowed and 1 not allowed
    $this->assertResponseStatus(200);
  }
}
