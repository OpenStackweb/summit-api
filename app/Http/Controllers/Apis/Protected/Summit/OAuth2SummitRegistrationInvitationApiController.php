      ...
      function () {
        return [
          ...
          "status" =>
            ...
            join(",", SummitRegistrationInvitation::AllowedStatus),
        ];
      },
      function () {
        return ["id", "email", "first_name", "last_name", "full_name", "status"];
      },
  ...
  public function send($summit_id) {
    return $this->processRequest(function () use ($summit_id) {
      ...
      $filter->validate([
        ...
        "tags_id" => "sometimes|integer",
        "status" =>
          "sometimes|required|string|in:" . join(",", SummitRegistrationInvitation::AllowedStatus),
      ]);
