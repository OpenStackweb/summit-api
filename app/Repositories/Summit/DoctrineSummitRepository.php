 ...
 */
final class DoctrineSummitRepository extends SilverStripeDoctrineRepository implements
  ISummitRepository {
  /**
   * @return array
   */
  protected function getFilterMappings() {
    return [
      ...
      "ticket_types_count" => new DoctrineHavingFilterMapping(
        "",
        "tt.summit",
        "count(tt.id) :operator :value",
      ),
