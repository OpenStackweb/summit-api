...
class Version20220718214726 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema): void
    {
        ...
        if($schema->hasTable("SponsoredProject") && !$builder->hasColumn("SponsoredProject", "ParentProjectID")) {
    ...
    public function down(Schema $schema): void
    {
        ...
        if($schema->hasTable("SponsoredProject") && $builder->hasColumn("SponsoredProject", "ParentProjectID")) {
            $builder->table('SponsoredProject', function (Table $table) {
                $table->dropColumn('ParentProjectID');
            });
        }
    }
}
