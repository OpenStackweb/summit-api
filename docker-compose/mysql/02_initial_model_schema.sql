...
(
    ...
    Created    datetime                                      not null,
    LastEdited datetime                                      not null,
    ClassName  varchar(255) default 'ExtraQuestionTypeValue' not null,
    Label      text                                          not null,
    Value      text                                          not null,
    `Order`    int          default 1                        not null,
    QuestionID int                                           null,
...
(
    ...
    UserID     int                                                                                                    null,
    constraint FK_956C7A1A58746832
...
(
    ...
    constraint UNIQ_82326859B172E6EC522B9974
        unique (SelectionPlanID, MemberID),
    constraint FK_SelectionPlan_AllowedMembers_M
        foreign key (MemberID) references Member (ID)
            on delete cascade,
...
create index MemberID
    on SelectionPlan_AllowedMembers (MemberID);
...
(
    ...
    NavBarTitle        varchar(255)                            null,
    ShouldShowOnNavBar tinyint(1)   default 1                  not null,
    LearnMoreLink      varchar(255)                            null,
    LearnMoreText      longtext                                null,
...
(
    ...
    RegistrationSendQRAsImageAttachmentOnTicketEmail   tinyint                         default 0        null,
    RegistrationSendTicketAsPDFAttachmentOnTicketEmail tinyint                         default 0        null,
...
(
    ...
    Created         datetime                                                                                    not null,
    LastEdited      datetime                                                                                    not null,
    ClassName       enum ('PresentationActionType', 'SelectionPlanActionType') default 'PresentationActionType' null,
    ...
    constraint FK_CB86755D90CF7278
        foreign key (SummitID) references Summit (ID)
            on delete cascade,
    constraint FK_CB86755DB172E6EC
        foreign key (SelectionPlanID) references SelectionPlan (ID)
)
    collate = utf8mb3_unicode_ci;

create index IDX_CB86755DB172E6EC
    on PresentationActionType (SelectionPlanID);
...
(
    ...
    AdminNotes                 varchar(1024) collate utf8mb4_general_ci                         null,
...
(
    ...
    constraint FK_SummitAttendeeBadgePrintAuditLog_AuditLog
        foreign key (ID) references AuditLog (ID)
            on delete cascade
)
    collate = utf8mb3_unicode_ci;

create index SummitAttendeeBadgePrintID
...
(
    ...
    Created         datetime                              not null,
    LastEdited      datetime                              not null,
    ClassName       varchar(255) default 'SummitDocument' not null,
    Name            varchar(255)                          not null,
...
(
    ...
    CustomOrder           int              default 1   not null,
    constraint Presentation_Speaker_Unique_IDX
        unique (PresentationID, PresentationSpeakerID),
...
(
    ...
    Source      varchar(255) default 'TrackChairs'            not null,
    SummitID    int                                           null,
    CreatedByID int                                           null,
...
(
    ...
    constraint FK_E4A0727590CF7278
        foreign key (SummitID) references Summit (ID)
            on delete cascade,
    constraint FK_E4A072759D1F4548
        foreign key (CompanyID) references Company (ID)
            on delete cascade
)
    collate = utf8mb3_unicode_ci;
...
(
    ...
    LocationID       int                                                        null,
    ImageID          int                                                        null,
    MillionCoreClub  tinyint(1)                           default 0             not null
)
    charset = latin1;
