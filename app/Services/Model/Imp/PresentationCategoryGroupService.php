 ...
 */
final class PresentationCategoryGroupService extends AbstractService implements
  IPresentationCategoryGroupService {
  /**
   ...
   */
  public function __construct(IGroupRepository $group_repository, ITransactionService $tx_service) {
    ...
    return $this->tx_service->transaction(function () use ($summit, $track_group_id, $data) {
      if (isset($data["name"])) {
        ...
        if (!is_null($former_track_group) && $former_track_group->getId() != $track_group_id) {
          throw new ValidationException(
            trans(
              "validation_errors.PresentationCategoryGroupService.updateTrackGroup.NameAlreadyExists",
              [
                "name" => trim($data["name"]),
                "summit_id" => $summit->getId(),
              ],
      ...
      if (is_null($track_group)) {
        throw new EntityNotFoundException(
          trans(
            "not_found_errors.PresentationCategoryGroupService.updateTrackGroup.TrackGroupNotFound",
            [
