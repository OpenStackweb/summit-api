...
final class DoctrineSummitProposedScheduleRepository
  ...
  public function getPublishedOnSameTimeFrame(IPublishableEvent $event): array {
    Log::debug(
      sprintf(
        "DoctrineSummitProposedScheduleRepository::getPublishedOnSameTimeFrame event id %s",
    ...
    $query = $this->getEntityManager()
      ...
      ->select("e")
      ->from(
        \App\Models\Foundation\Summit\ProposedSchedule\SummitProposedScheduleSummitEvent::class,
        "e",
      )
