...
use Exception;
/**
 * Trait AddSelectionPlanChildElement
...
trait AddSelectionPlanChildElement
{
     ...
     * @return IEntity
     */
    abstract protected function addChild(SelectionPlan $selection_plan, array $payload):IEntity;
     ...
     */
    public function add($summit_id, $selection_plan_id){
        try {
            ...
            $child = $this->addChild($selection_plan, $payload);
