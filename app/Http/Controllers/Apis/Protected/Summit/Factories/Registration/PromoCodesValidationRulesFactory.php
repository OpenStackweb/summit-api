...
final class PromoCodesValidationRulesFactory extends AbstractValidationRulesFactory {
  ...
  public static function buildForAdd(array $payload = []): array {
    ...
    $base_rules = [
      ...
      "valid_until_date" =>
        "nullable|required_with:valid_since_date|date_format:U|after:valid_since_date",
    ...
    switch ($class_name) {
      case MemberSummitRegistrationPromoCode::ClassName:
        $specific_rules = [
          ...
          "type" =>
            "required|string|in:" .
            join(",", PromoCodesConstants::MemberSummitRegistrationPromoCodeTypes),
      ...
      case SpeakerSummitRegistrationPromoCode::ClassName:
        $specific_rules = [
          "type" =>
            "required|string|in:" .
            join(",", PromoCodesConstants::SpeakerSummitRegistrationPromoCodeTypes),
