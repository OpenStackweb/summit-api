...
final class SelectionPlanSerializer extends SilverStripeSerializer {
  protected static $array_mappings = [
    ...
    "SubmissionLockDownPresentationStatusDate" =>
      "submission_lock_down_presentation_status_date:datetime_epoch",
    ...
    "PresentationCreatorNotificationEmailTemplate" =>
      "presentation_creator_notification_email_template:json_string",
    "PresentationModeratorNotificationEmailTemplate" =>
      "presentation_moderator_notification_email_template:json_string",
    "PresentationSpeakerNotificationEmailTemplate" =>
      "presentation_speaker_notification_email_template:json_string",
  ...
  public function serialize(
    ...
    if (
      in_array("track_chair_rating_types", $relations) &&
      !isset($values["track_chair_rating_types"])
    ) {
      $track_chair_rating_types = [];
    ...
    if (
      in_array("allowed_presentation_action_types", $relations) &&
      !isset($values["allowed_presentation_action_types"])
    ) {
      $allowed_presentation_action_types = [];
