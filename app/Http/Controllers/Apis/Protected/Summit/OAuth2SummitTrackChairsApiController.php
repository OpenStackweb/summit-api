 ...
 */
final class OAuth2SummitTrackChairsApiController extends OAuth2ProtectedController {
  /**
  ...
  public function addTrack2TrackChair($summit_id, $track_chair_id, $track_id) {
    try {
      ...
      $track_chair = $this->service->addTrack2TrackChair(
        $summit,
        intval($track_chair_id),
        intval($track_id),
      );
      return $this->updated(
        SerializerRegistry::getInstance()
          ->getSerializer($track_chair)
  ...
  public function removeFromTrackChair($summit_id, $track_chair_id, $track_id) {
    try {
      ...
      $track_chair = $this->service->removeFromTrackChair(
        $summit,
        intval($track_chair_id),
        intval($track_id),
      );
