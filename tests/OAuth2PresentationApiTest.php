...
final class OAuth2PresentationApiTest extends ProtectedApiTestCase {
  ...
  public function testAddTrackChairScore() {
    $params = [
      ...
      "score_type_id" => self::$default_selection_plan
        ->getTrackChairRatingTypes()[0]
        ->getScoreTypes()[0]
        ->getId(),
    ];
    ...
    $this->assertTrue(
      $score->presentation_id === self::$default_selection_plan->getPresentations()[0]->getId(),
    );
  ...
  public function testAddTwiceTrackChairScore() {
    ...
    $this->assertTrue(
      $score->type_id ===
        self::$default_selection_plan->getTrackChairRatingTypes()[0]->getScoreTypes()[0]->getId(),
    );
    ...
    $this->assertTrue(
      $score->type_id ===
        self::$default_selection_plan->getTrackChairRatingTypes()[0]->getScoreTypes()[1]->getId(),
    );
