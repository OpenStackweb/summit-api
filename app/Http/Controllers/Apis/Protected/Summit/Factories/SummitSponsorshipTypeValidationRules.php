...
final class SummitSponsorshipTypeValidationRules extends AbstractValidationRulesFactory {
  ...
  public static function buildForAdd(array $payload = []): array {
    return [
      ...
      "lobby_template" =>
        "sometimes|nullable|string|in:" . join(",", SummitSponsorshipType::ValidLobbyTemplates),
      "expo_hall_template" =>
        "sometimes|nullable|string|in:" . join(",", SummitSponsorshipType::ValidExpoHallTemplates),
      "sponsor_page_template" =>
        "sometimes|nullable|string|in:" .
        join(",", SummitSponsorshipType::ValidSponsorPageTemplates),
      "event_page_template" =>
        "sometimes|nullable|string|in:" . join(",", SummitSponsorshipType::ValidEventPageTemplates),
