 ...
 */
class PresentationTrackChairRatingType extends SilverstripeBaseModel implements IOrderable {
  ...
  public function addScoreType(PresentationTrackChairScoreType $score): void {
    if ($this->score_types->contains($score)) {
      return;
    }
   ...
   * @throws ValidationException
   */
  public function recalculateScoreTypeScore(
    PresentationTrackChairScoreType $scoreType,
    $new_score,
  ) {
    ...
    self::recalculateOrderForSelectable(
      ...
      $scoreType,
      $new_score,
      PresentationTrackChairScoreType::class,
    );
  }
