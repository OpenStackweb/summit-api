...
final class OwnMemberSerializer extends AbstractMemberSerializer {
  ...
  public function serialize(
    ...
    if (in_array("sponsor_memberships", $relations)) {
      $res = [];
      $sponsorship_expand = AbstractSerializer::filterExpandByPrefix(
        $expand,
        "sponsor_memberships",
      );
      if (empty($sponsorship_expand)) {
        $sponsorship_expand = "summit,company,sponsorship";
      }
      ...
      foreach (explode(",", $expand) as $relation) {
        ...
        switch ($relation) {
          ...
          case "favorite_summit_events":
            if (!in_array("favorite_summit_events", $relations)) {
              break;
            }
            if (is_null($summit)) {
              break;
          ...
          case "schedule_summit_events":
            if (!in_array("schedule_summit_events", $relations)) {
              break;
            }
            if (is_null($summit)) {
              break;
            ...
            break;
          case "summit_tickets":
            if (!in_array("summit_tickets", $relations)) {
              break;
            }
            if (is_null($summit)) {
              break;
