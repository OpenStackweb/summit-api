...
return [
    ...
    'get_summit_response_lifetime_v2'       => env('CACHE_API_RESPONSE_GET_SUMMIT_LIFETIME_V2', 300),
    ...
    'event_has_access_lifetime'             => env('CACHE_API_RESPONSE_EVENT_HAS_ACCESS_LIFETIME', 600),
];