 ...
 */
final class DoctrineSummitLocationRepository extends SilverStripeDoctrineRepository implements
  ...
  protected function getFilterMappings() {
    return [
      ...
      "class_name" => new DoctrineInstanceOfFilterMapping("al", [
  ...
  public function getBySummit(
    ...
    if ($first_level) {
      ...
      foreach (self::$second_level_locations as $second_level_location) {
        $query = $query->andWhere("not al INSTANCE OF :second_level_class" . $idx);
