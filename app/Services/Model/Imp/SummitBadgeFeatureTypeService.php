 ...
 */
final class SummitBadgeFeatureTypeService extends AbstractService implements
   ...
   */
  public function __construct(IFileUploader $file_uploader, ITransactionService $tx_service) {
