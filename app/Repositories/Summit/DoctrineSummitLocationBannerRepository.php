 ...
 */
final class DoctrineSummitLocationBannerRepository extends SilverStripeDoctrineRepository implements
  ISummitLocationBannerRepository {
  protected function getFilterMappings() {
    return [
      ...
      "class_name" => new DoctrineInstanceOfFilterMapping("b", [
