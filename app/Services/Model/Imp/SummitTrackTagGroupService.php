 ...
 */
final class SummitTrackTagGroupService extends AbstractService implements
  ISummitTrackTagGroupService {
  /**
   * @var ITagRepository
   */
    ...
    return $this->tx_service->transaction(function () use ($summit, $track_tag_group_id, $data) {
      ...
      if (is_null($track_tag_group)) {
        throw new EntityNotFoundException(
          trans(
            "not_found_errors.SummitTrackTagGroupService.updateTrackTagGroup.TrackTagGroupNotFound",
            [
              "summit_id" => $summit->getId(),
  ...
  public function deleteTrackTagGroup(Summit $summit, $track_tag_group_id) {
    $this->tx_service->transaction(function () use ($summit, $track_tag_group_id) {
      ...
      if (is_null($track_tag_group)) {
        throw new EntityNotFoundException(
          trans(
            "not_found_errors.SummitTrackTagGroupService.deleteTrackTagGroup.TrackTagGroupNotFound",
            [
              "summit_id" => $summit->getId(),
              "track_tag_group_id" => $track_tag_group_id,
            ],
  ...
  public function seedTagOnAllTrack(Summit $summit, $tag_id) {
    return $this->tx_service->transaction(function () use ($summit, $tag_id) {
      ...
      if (is_null($tag)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.SummitTrackTagGroupService.seedTagOnAllTrack.TagNotFound", [
            "tag_id" => $tag_id,
          ]),
        );
      }
  ...
  public function seedTagTrackGroupTagsOnTrack(Summit $summit, $track_tag_group_id, $track_id) {
    return $this->tx_service->transaction(function () use (
      ...
      if (is_null($track_tag_group)) {
        throw new EntityNotFoundException(
          trans(
            "not_found_errors.SummitTrackTagGroupService.seedTagTrackGroupTagsOnTrack.TrackTagGroupNotFound",
            [
              "summit_id" => $summit->getId(),
              "track_tag_group_id" => $track_tag_group_id,
            ],
      ...
      if (is_null($track)) {
        throw new EntityNotFoundException(
          trans(
            "not_found_errors.SummitTrackTagGroupService.seedTagTrackGroupTagsOnTrack.TrackNotFound",
            [
              "summit_id" => $summit->getId(),
              "track_id" => $track_id,
            ],
