 ...
 */
#[OA\Tag(name: "Elections", description: "Elections Management Endpoints")]
class OAuth2ElectionsApiController extends OAuth2ProtectedController
{
    ...
    #[OA\Get(
        ...
        description: "Get all accepted candidates for the current election",
        tags: ["Elections"],
        parameters: [
            new OA\Parameter(
                name: "page",
    ...
    #[OA\Get(
        ...
        description: "Get all accepted candidates for a specific election",
        tags: ["Elections"],
        parameters: [
            new OA\Parameter(
                name: "election_id",
    ...
    #[OA\Get(
        ...
        operationId: "getCurrentElectionGoldCandidates",
        description: "Get gold (featured/premium) candidates for the current election",
        tags: ["Elections"],
        parameters: [
            new OA\Parameter(
                name: "page",
    ...
    #[OA\Get(
        ...
        description: "Get gold (featured/premium) candidates for a specific election",
        tags: ["Elections"],
        parameters: [
            new OA\Parameter(
                name: "election_id",
            ...
            content: new OA\JsonContent(
                ...
                properties: [
                    new OA\Property(
                        property: "comment",
                        type: "string",
                        description: "Optional comment for the nomination"
                    ),
                ]
            )
        ),
