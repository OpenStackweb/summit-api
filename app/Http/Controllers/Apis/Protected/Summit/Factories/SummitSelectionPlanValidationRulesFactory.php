...
final class SummitSelectionPlanValidationRulesFactory extends AbstractValidationRulesFactory {
  ...
  public static function buildForAdd(array $payload = []): array {
    return [
      ...
      "submission_end_date" =>
        "nullable|required_with:submission_begin_date|date_format:U|after_or_equal:submission_begin_date",
      "submission_lock_down_presentation_status_date" => "nullable|date_format:U",
      "voting_begin_date" => "nullable|date_format:U",
      "voting_end_date" =>
        "nullable|required_with:voting_begin_date|date_format:U|after_or_equal:voting_begin_date",
      "selection_begin_date" => "nullable|date_format:U",
      "selection_end_date" =>
        "nullable|required_with:selection_begin_date|date_format:U|after_or_equal:selection_begin_date",
