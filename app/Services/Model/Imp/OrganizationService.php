 ...
 */
final class OrganizationService extends AbstractService implements IOrganizationService {
  /**
    ...
    return $this->tx_service->transaction(function () use ($data) {
      ...
      if (!is_null($old_organization)) {
        throw new ValidationException(
          trans("validation_errors.OrganizationService.addOrganization.alreadyExistName", [
            "name" => $name,
          ]),
        );
      }
