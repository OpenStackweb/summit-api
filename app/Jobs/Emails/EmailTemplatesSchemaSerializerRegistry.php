...
final class EmailTemplatesSchemaSerializerRegistry {
  ...
  private function __construct() {
    ...
    $this->registry[BookableRoomReservationCanceledEmail::EVENT_SLUG] =
      AbstractBookableRoomReservationEmail::class;
    $this->registry[BookableRoomReservationCreatedEmail::EVENT_SLUG] =
      AbstractBookableRoomReservationEmail::class;
    $this->registry[BookableRoomReservationPaymentConfirmedEmail::EVENT_SLUG] =
      AbstractBookableRoomReservationEmail::class;
    $this->registry[BookableRoomReservationRefundAcceptedEmail::EVENT_SLUG] =
      AbstractBookableRoomReservationEmail::class;
    $this->registry[BookableRoomReservationRefundRequestedAdminEmail::EVENT_SLUG] =
      AbstractBookableRoomReservationEmail::class;
    $this->registry[BookableRoomReservationRefundRequestedOwnerEmail::EVENT_SLUG] =
      AbstractBookableRoomReservationEmail::class;
    ...
    $this->registry[PresentationCategoryChangeRequestCreatedEmail::EVENT_SLUG] =
      PresentationCategoryChangeRequestCreatedEmail::class;
    $this->registry[PresentationCategoryChangeRequestResolvedEmail::EVENT_SLUG] =
      PresentationCategoryChangeRequestResolvedEmail::class;
    ...
    $this->registry[PresentationSpeakerSelectionProcessAcceptedAlternateEmail::EVENT_SLUG] =
      PresentationSpeakerSelectionProcessAcceptedAlternateEmail::class;
    $this->registry[PresentationSpeakerSelectionProcessAcceptedOnlyEmail::EVENT_SLUG] =
      PresentationSpeakerSelectionProcessAcceptedOnlyEmail::class;
    $this->registry[PresentationSpeakerSelectionProcessAcceptedRejectedEmail::EVENT_SLUG] =
      PresentationSpeakerSelectionProcessAcceptedRejectedEmail::class;
    $this->registry[PresentationSpeakerSelectionProcessAlternateOnlyEmail::EVENT_SLUG] =
      PresentationSpeakerSelectionProcessAlternateOnlyEmail::class;
    $this->registry[PresentationSpeakerSelectionProcessAlternateRejectedEmail::EVENT_SLUG] =
      PresentationSpeakerSelectionProcessAlternateRejectedEmail::class;
    $this->registry[PresentationSpeakerSelectionProcessRejectedOnlyEmail::EVENT_SLUG] =
      PresentationSpeakerSelectionProcessEmail::class;
    $this->registry[PresentationSubmitterSelectionProcessAcceptedAlternateEmail::EVENT_SLUG] =
      PresentationSubmitterSelectionProcessEmail::class;
    $this->registry[PresentationSubmitterSelectionProcessAcceptedOnlyEmail::EVENT_SLUG] =
      PresentationSubmitterSelectionProcessEmail::class;
    $this->registry[PresentationSubmitterSelectionProcessAcceptedRejectedEmail::EVENT_SLUG] =
      PresentationSubmitterSelectionProcessEmail::class;
    $this->registry[PresentationSubmitterSelectionProcessAlternateOnlyEmail::EVENT_SLUG] =
      PresentationSubmitterSelectionProcessEmail::class;
    $this->registry[PresentationSubmitterSelectionProcessAlternateRejectedEmail::EVENT_SLUG] =
      PresentationSubmitterSelectionProcessEmail::class;
    $this->registry[PresentationSubmitterSelectionProcessRejectedOnlyEmail::EVENT_SLUG] =
      PresentationSubmitterSelectionProcessEmail::class;
    $this->registry[PresentationSpeakerSelectionProcessExcerptEmail::EVENT_SLUG] =
      PresentationSpeakerSelectionProcessExcerptEmail::class;
    $this->registry[PresentationSubmitterSelectionProcessExcerptEmail::EVENT_SLUG] =
      PresentationSubmitterSelectionProcessExcerptEmail::class;

    $this->registry[ImportEventSpeakerEmail::EVENT_SLUG] = ImportEventSpeakerEmail::class;
    $this->registry[PresentationCreatorNotificationEmail::EVENT_SLUG] =
      PresentationCreatorNotificationEmail::class;
    $this->registry[PresentationModeratorNotificationEmail::EVENT_SLUG] =
      PresentationModeratorNotificationEmail::class;
    $this->registry[PresentationSpeakerNotificationEmail::EVENT_SLUG] =
      PresentationSpeakerNotificationEmail::class;
    $this->registry[SpeakerCreationEmail::EVENT_SLUG] = SpeakerCreationEmail::class;
    $this->registry[SpeakerEditPermissionApprovedEmail::EVENT_SLUG] =
      SpeakerEditPermissionApprovedEmail::class;
    $this->registry[SpeakerEditPermissionRejectedEmail::EVENT_SLUG] =
      SpeakerEditPermissionRejectedEmail::class;
    $this->registry[SpeakerEditPermissionRequestedEmail::EVENT_SLUG] =
      SpeakerEditPermissionRequestedEmail::class;
    ...
    $this->registry[InviteAttendeeTicketEditionMail::EVENT_SLUG] =
      InviteAttendeeTicketEditionMail::class;
    $this->registry[RevocationTicketEmail::EVENT_SLUG] = RevocationTicketEmail::class;
    $this->registry[SummitAttendeeAllTicketsEditionEmail::EVENT_SLUG] =
      SummitAttendeeAllTicketsEditionEmail::class;
    $this->registry[SummitAttendeeRegistrationIncompleteReminderEmail::EVENT_SLUG] =
      SummitAttendeeRegistrationIncompleteReminderEmail::class;
    $this->registry[SummitAttendeeTicketEmail::EVENT_SLUG] = SummitAttendeeTicketEmail::class;
    $this->registry[SummitAttendeeTicketRegenerateHashEmail::EVENT_SLUG] =
      InviteAttendeeTicketEditionMail::class;
    ...
    $this->registry[InviteSummitRegistrationEmail::EVENT_SLUG] =
      InviteSummitRegistrationEmail::class;
    $this->registry[ReInviteSummitRegistrationEmail::EVENT_SLUG] =
      ReInviteSummitRegistrationEmail::class;
    ...
    $this->registry[SummitOrderRefundRequestAdmin::EVENT_SLUG] =
      SummitOrderRefundRequestAdmin::class;
    $this->registry[SummitOrderRefundRequestOwner::EVENT_SLUG] =
      SummitOrderRefundRequestOwner::class;
    ...
    $this->registry[SummitTicketRefundRequestAdmin::EVENT_SLUG] =
      SummitTicketRefundRequestAdmin::class;
    $this->registry[SummitTicketRefundRequestOwner::EVENT_SLUG] =
      SummitTicketRefundRequestOwner::class;
    ...
    $this->registry[RegisteredMemberOrderPaidMail::EVENT_SLUG] =
      RegisteredMemberOrderPaidMail::class;
    $this->registry[SpeakerPromoCodeEMail::EVENT_SLUG] = PromoCodeEmail::class;
    $this->registry[UnregisteredMemberOrderPaidMail::EVENT_SLUG] =
      UnregisteredMemberOrderPaidMail::class;
