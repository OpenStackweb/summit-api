...
final class SummitLocationBannerFactory {
  ...
  public static function build(Summit $summit, SummitAbstractLocation $location, array $data) {
    ...
    switch ($data["class_name"]) {
      case SummitLocationBanner::ClassName:
        $banner = self::populateSummitLocationBanner(
          $summit,
          $location,
          new SummitLocationBanner(),
          $data,
        );
        break;
      case ScheduledSummitLocationBanner::ClassName:
        $banner = self::populateScheduledSummitLocationBanner(
          $summit,
          $location,
          new ScheduledSummitLocationBanner(),
          $data,
        );
    }
    return $banner;
   ...
   */
  private static function populateSummitLocationBanner(
    Summit $summit,
   ...
   * @throws ValidationException
   */
  private static function populateScheduledSummitLocationBanner(
    Summit $summit,
    SummitAbstractLocation $location,
    ScheduledSummitLocationBanner $banner,
    array $data,
  ) {
    ...
    if (isset($data["start_date"]) && isset($data["end_date"])) {
      ...
      if (
        !$summit->isTimeFrameInsideSummitDuration(
          $banner->getLocalStartDate(),
          $banner->getLocalEndDate(),
        )
      ) {
        throw new ValidationException(
          sprintf(
  ...
  public static function populate(
    ...
    } elseif ($banner instanceof SummitLocationBanner) {
