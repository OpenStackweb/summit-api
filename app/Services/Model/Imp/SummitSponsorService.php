    ...
    implements ISummitSponsorService
{
     ...
     * @param ISponsorshipTypeRepository $sponsorship_type_repository
     ...
     * @return File
     */
    public function addSponsorSideImage(Summit $summit, int $sponsor_id, UploadedFile $file, $max_file_size = 10485760): File
    {
     ...
     * @return File
     */
    public function addSponsorHeaderImage(Summit $summit, int $sponsor_id, UploadedFile $file, $max_file_size = 10485760): File
    {
        return $this->tx_service->transaction(function () use ($summit, $sponsor_id, $file, $max_file_size) {
     ...
     * @throws ValidationException
     */
    public function addSponsorAdImage(Summit $summit, int $sponsor_id, int $ad_id, UploadedFile $file, $max_file_size = 10485760): File
    {
