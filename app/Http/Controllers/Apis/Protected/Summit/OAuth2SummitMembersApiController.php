 ...
 */
#[OA\Tag(name: "Summit Members", description: "Summit Members endpoints")]
final class OAuth2SummitMembersApiController extends OAuth2ProtectedController
{
    ...
    #[OA\Get(
        ...
        tags: ["Summit Members"],
        responses: [
            new OA\Response(response: HttpResponse::HTTP_OK, description: "List of favorite events", content: new OA\JsonContent(
                type: "object",
                properties: [
    ...
    #[OA\Get(
        ...
        tags: ["Summit Members"],
        responses: [
            new OA\Response(response: HttpResponse::HTTP_OK, description: "List of schedule events", content: new OA\JsonContent(
                type: "object",
                properties: [
                    new OA\Property(property: "data", type: "array", items: new OA\Items(type: "object")),
                    new OA\Property(property: "page", type: "integer"),
    ...
    #[OA\Get(
        ...
        description: "Get all members by summit",
        parameters: [
            new OA\Parameter(name: "id", description: "Summit ID", in: "path", required: true, schema: new OA\Schema(type: "integer")),
        ...
        tags: ["Summit Members"],
        responses: [
            new OA\Response(response: HttpResponse::HTTP_OK, description: "List of members", content: new OA\JsonContent(
                type: "object",
                properties: [
    ...
    #[OA\Get(
        ...
        description: "Export all members by summit as CSV",
        parameters: [
            new OA\Parameter(name: "id", description: "Summit ID", in: "path", required: true, schema: new OA\Schema(type: "integer")),
            new OA\Parameter(name: "page", description: "Page number", in: "query", schema: new OA\Schema(type: "integer", default: 1)),
    ...
    #[OA\Get(
        ...
        description: "Get calendar feed in ICS format",
        parameters: [
            new OA\Parameter(name: "id", description: "Summit ID", in: "path", required: true, schema: new OA\Schema(type: "integer")),
