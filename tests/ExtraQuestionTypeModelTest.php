...
class MockExtraQuestionAnswerHolder
{
    ...
    public function __construct(Summit $current_summit)
    {
        ...
        $questions = $this->current_summit->getMainOrderExtraQuestionsByUsage(SummitOrderExtraQuestionTypeConstants::TicketQuestionUsage);
...
class ExtraQuestionTypeModelTest extends BrowserKitTestCase
{
    ...
    {
        $main_questions = self::$summit->getMainOrderExtraQuestionsByUsage(SummitOrderExtraQuestionTypeConstants::TicketQuestionUsage);
