    ...
    switch ($class_name) {
      case PresentationType::ClassName:
        $specific_rules = [
          ...
          "max_speakers" =>
            "sometimes|integer|required_with:use_speakers|greater_than_field:min_speakers",
          ...
          "max_moderators" =>
            "sometimes|integer|required_with:use_moderator|greater_than_field:min_moderators",
