...
final class SummitEventFactory {
   ...
   */
  public static function build(SummitEventType $type, Summit $summit, array $payload = []) {
   ...
   * @throws ValidationException
   */
  public static function populate(Summit $summit, SummitEvent $event, array $payload): SummitEvent {
    // selection plan
    ...
    $event->setAllowFeedBack(
      isset($payload["allow_feedback"])
