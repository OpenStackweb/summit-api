  ...
  public static function buildForAdd(array $payload = []): array {
    return [
      ...
      "registration_end_date" =>
        "nullable|required_with:registration_begin_date|date_format:U|after_or_equal:registration_begin_date",
      "start_showing_venues_date" => "nullable|date_format:U|before_or_equal:start_date",
      "schedule_start_date" =>
        "nullable|date_format:U|after_or_equal:start_date|before_or_equal:end_date",
      ...
      "meeting_room_booking_end_time" =>
        "nullable|required_with:meeting_room_booking_start_time|date_format:U|after_or_equal:meeting_room_booking_start_time",
      "meeting_room_booking_slot_length" => "nullable|integer",
      "meeting_room_booking_max_allowed" => "nullable|integer|min:1",
      "api_feed_type" => sprintf(
        "nullable|in:%s",
        implode(",", ISummitExternalScheduleFeedType::ValidFeedTypes),
      ),
      ...
      "end_allow_booking_date" =>
        "nullable|required_with:begin_allow_booking_date|date_format:U|after_or_equal:begin_allow_booking_date",
      ...
      "external_registration_feed_type" => sprintf(
        "nullable|in:%s",
        implode(",", ISummitExternalRegistrationFeedType::ValidFeedTypes),
      ),
      "external_registration_feed_api_key" =>
        "nullable|string|required_with:external_registration_feed_type",
      // schedule
