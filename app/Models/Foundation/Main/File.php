...
class File extends SilverstripeBaseModel {
  ...
  public function getUrl() {
    $local =
      Config::get("server.assets_base_url", "https://www.openstack.org/") . $this->getFilename();
  ...
  public static function getCloudLinkForImages(string $imageRelativePath): ?string {
    try {
      ...
      return Storage::disk(Config::get("filesystems.static_images_disk", "static_images"))->url(
        $imageRelativePath,
      );
    } catch (\Exception $ex) {
      Log::warning($ex);
