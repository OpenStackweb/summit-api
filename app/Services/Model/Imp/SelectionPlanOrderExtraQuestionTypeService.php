 ...
 */
final class SelectionPlanOrderExtraQuestionTypeService extends ExtraQuestionTypeService implements
  ISelectionPlanExtraQuestionTypeService {
  /**
  ...
  public function updateExtraQuestionBySelectionPlan(
    ...
    return $this->tx_service->transaction(function () use (
      ...
      if (isset($payload["order"]) && intval($payload["order"]) != $assignment->getOrder()) {
        ...
        Log::debug(
          sprintf(
            "SelectionPlanOrderExtraQuestionTypeService::updateExtraQuestionBySelectionPlan recalculating order",
          ),
        );
