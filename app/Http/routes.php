...
Route::group([
    ...
    Route::group(array('prefix' => 'summits'), function () {
        ...
        Route::group(['prefix' => '{id}'], function () {
            ...
            Route::post('logo', [ 'middleware' => 'auth.user:administrators|summit-front-end-administrators', 'uses' => 'OAuth2SummitApiController@addSummitLogo']);
            Route::delete('logo', [ 'middleware' => 'auth.user:administrators|summit-front-end-administrators', 'uses' => 'OAuth2SummitApiController@deleteSummitLogo']);
                        ...
                        Route::group(['prefix' => 'rooms'], function () {
                            ...
                            Route::group(['prefix' => '{room_id}'], function () {
                                ...
                                Route::group(['prefix' => 'image'], function () {
                                    Route::post('',  [ 'middleware' => 'auth.user:administrators|summit-front-end-administrators', 'uses' => 'OAuth2SummitLocationsApiController@addVenueRoomImage']);
                                    Route::delete('',  [ 'middleware' => 'auth.user:administrators|summit-front-end-administrators', 'uses' => 'OAuth2SummitLocationsApiController@removeVenueRoomImage']);
                                });
                            });
                        });
