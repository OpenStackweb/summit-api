 ...
 */
final class GoogleCalendarSyncRemoteFacade extends AbstractCalendarSyncRemoteFacade {
  /**
   * @var \Google_Client
   */
  private $client;
  ...
  private function checkAccessToken() {
    if ($this->client->isAccessTokenExpired()) {
      $creds = $this->client->fetchAccessTokenWithRefreshToken(
        $this->sync_calendar_info->getRefreshToken(),
      );
  ...
  public function createCalendar(
    ...
    try {
      ...
      Log::info(
        sprintf("GoogleCalendarSyncRemoteFacade::createCalendar: calendarId %s", $calendar_id),
      );
  ...
  public function deleteCalendar(
    ...
    try {
      ...
      Log::info(
        sprintf(
          "GoogleCalendarSyncRemoteFacade::deleteCalendar: calendarId %s",
          $calendar_sync_info->getExternalId(),
        ),
      );
