 ...
 */
final class OAuth2PresentationCategoryGroupController extends OAuth2ProtectedController {
  /**
  ...
  public function getAllBySummit($summit_id) {
    ...
    try {
      ...
      if (Request::has("order")) {
        $order = OrderParser::parse(Request::input("order"), ["id", "name", "slug"]);
      }
  ...
  public function updateTrackGroupBySummit($summit_id, $track_group_id) {
    try {
      ...
      $track_group = $this->presentation_category_group_service->updateTrackGroup(
        $summit,
        $track_group_id,
        $payload,
      );
      ...
      return $this->updated(
        SerializerRegistry::getInstance()->getSerializer($track_group)->serialize(),
      );
    } catch (ValidationException $ex1) {
      Log::warning($ex1);
      return $this->error412([$ex1->getMessage()]);
  ...
  public function associateTrack2TrackGroup($summit_id, $track_group_id, $track_id) {
    try {
      ...
      $this->presentation_category_group_service->associateTrack2TrackGroup(
        $summit,
        $track_group_id,
        $track_id,
      );
  ...
  public function disassociateTrack2TrackGroup($summit_id, $track_group_id, $track_id) {
    try {
      ...
      $this->presentation_category_group_service->disassociateTrack2TrackGroup(
        $summit,
        $track_group_id,
        $track_id,
      );
  ...
  public function associateAllowedGroup2TrackGroup($summit_id, $track_group_id, $group_id) {
    try {
      ...
      $this->presentation_category_group_service->associateAllowedGroup2TrackGroup(
        $summit,
        $track_group_id,
        $group_id,
      );
  ...
  public function disassociateAllowedGroup2TrackGroup($summit_id, $track_group_id, $group_id) {
    try {
      ...
      $this->presentation_category_group_service->disassociateAllowedGroup2TrackGroup(
        $summit,
        $track_group_id,
        $group_id,
      );
