...
final class SummitSponsorshipTypeFactory
{
     ...
     * @return SummitSponsorshipType
     */
    public static function populate(SummitSponsorshipType $type, array $payload):SummitSponsorshipType{
        ...
        if(isset($payload['sponsor_page_use_live_event_widget']))
            $type->setSponsorPageUseLiveEventWidget(boolval($payload['sponsor_page_use_live_event_widget']));
