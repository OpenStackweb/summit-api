...
final class OAuth2SummitOrdersApiTest extends ProtectedApiTestCase {
  ...
  public function testUpdateMyOrder() {
    ...
    $data = [
      ...
      "extra_questions" => [["question_id" => 1, "answer" => "test"]],
    ];
  ...
  public function testReserveWithSummit() {
    ...
    $data = [
      ...
      "tickets" => [["type_id" => self::$ticketType->getId()]],
    ];
  ...
  public function testCheckoutFailedCountryValidation(
    $summit_id = 27,
    $hash = "ab45277bd50ba2d3284e56f06f2710049e5950927ec304fb7f8ea36e43cea931",
  ) {
    $params = [
      "id" => $summit_id,
      "hash" => $hash,
  ...
  public function testGetTicketForEditionByOrderHash(
    $summit_id = 1,
    $hash = "eb758846226109a736c512a6e0d682bdc6a3af67a0ad316315158f49c5f8f7e9",
  ) {
    $params = [
      "id" => $summit_id,
      "hash" => $hash,
