  ...
  public static function build(array $data, $update = false) {
    ...
    $base_rules = [
      ...
      "begin_attendee_voting_period_date" =>
        "nullable|date_format:U|required_with:submission_begin_date",
      "end_attendee_voting_period_date" =>
        "nullable|date_format:U|required_with:begin_attendee_voting_period_date|after:begin_attendee_voting_period_date",
    ];
    ...
    switch ($class_name) {
      case PrivatePresentationCategoryGroup::ClassName:
        $specific_rules = [
          ...
          "submission_end_date" =>
            "nullable|date_format:U|required_with:submission_begin_date|after:submission_begin_date",
