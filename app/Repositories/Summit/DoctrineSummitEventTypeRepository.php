 ...
 */
final class DoctrineSummitEventTypeRepository extends SilverStripeDoctrineRepository implements
  ISummitEventTypeRepository {
  /**
   * @return string
   */
  ...
  protected function getFilterMappings() {
    return [
      ...
      "class_name" => new DoctrineInstanceOfFilterMapping("et", [
  ...
  public function getBySummit(
    ...
    if (!is_null($filter)) {
      Log::debug(
        sprintf("DoctrineSummitEventTypeRepository::getBySummit filter %s", $filter->__toString()),
      );
