...
class DefaultEntityManyToManyCollectionUpdateAuditLogFormatterTest extends TestCase
{
    ...
    public function testFormatIgnoresLegacyPayloadAddedAndRemovedAndUsesCollectionDiff(): void
    {
        $this->formatter->setContext(AuditContextBuilder::default()->build());
        ...
        $this->assertNotNull($result);
        $this->assertStringContainsString(self::LOG_UPDATED_PREFIX, $result);
        $this->assertStringContainsString('Added 2 Tag(s): 2, 3', $result);
        $this->assertStringNotContainsString('Removed 1 Tag(s): 1', $result);
    }

    public function testFormatWithLegacyEmptyPayloadStillUsesCollectionDiff(): void
    {
        $this->formatter->setContext(AuditContextBuilder::default()->build());
    ...
    public function testFormatWithLegacyPayloadAndChildFormatterStillUsesChildDiff(): void
    {
