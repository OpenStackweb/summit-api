...
final class OAuth2SummitPromoCodesApiController extends OAuth2ProtectedController {
  ...
  public function getAllBySummit($summit_id) {
    ...
    return $this->_getAll(
      ...
      function () {
        return new Order([OrderElement::buildAscFor("id")]);
      },
      null,
  ...
  public function getMetadata($summit_id) {
    ...
    return $this->ok($this->repository->getMetadata($summit));
  }
  ...
  public function addPromoCodeBySummit($summit_id) {
    return $this->processRequest(function () use ($summit_id) {
      ...
      $payload = $this->getJsonPayload(
        PromoCodesValidationRulesFactory::buildForAdd($this->getJsonData()),
        true,
      );

      $promo_code = $this->promo_code_service->addPromoCode(
        $summit,
        $payload,
  ...
  public function updatePromoCodeBySummit($summit_id, $promo_code_id) {
    return $this->processRequest(function () use ($summit_id, $promo_code_id) {
      ...
      $payload = $this->getJsonPayload(
        PromoCodesValidationRulesFactory::buildForUpdate($this->getJsonData()),
        true,
      );

      $promo_code = $this->promo_code_service->updatePromoCode(
        $summit,
        intval($promo_code_id),
        $payload,
        $this->resource_server_context->getCurrentUser(),
      );
  ...
  public function addBadgeFeatureToPromoCode($summit_id, $promo_code_id, $badge_feature_id) {
    return $this->processRequest(function () use ($summit_id, $promo_code_id, $badge_feature_id) {
      ...
      $promo_code = $this->promo_code_service->addPromoCodeBadgeFeature(
        $summit,
        intval($promo_code_id),
        intval($badge_feature_id),
      );
      return $this->updated(
        SerializerRegistry::getInstance()
          ->getSerializer($promo_code)
  ...
  public function removeBadgeFeatureFromPromoCode($summit_id, $promo_code_id, $badge_feature_id) {
    return $this->processRequest(function () use ($summit_id, $promo_code_id, $badge_feature_id) {
      ...
      $promo_code = $this->promo_code_service->removePromoCodeBadgeFeature(
        $summit,
        intval($promo_code_id),
        intval($badge_feature_id),
      );
  ...
  public function addTicketTypeToPromoCode($summit_id, $promo_code_id, $ticket_type_id) {
    return $this->processRequest(function () use ($summit_id, $promo_code_id, $ticket_type_id) {
      ...
      $promo_code = $this->promo_code_service->addPromoCodeTicketTypeRule(
        $summit,
        intval($promo_code_id),
        intval($ticket_type_id),
        $payload,
      );
      return $this->updated(
        SerializerRegistry::getInstance()
  ...
  public function ingestPromoCodes(LaravelRequest $request, $summit_id) {
    return $this->processRequest(function () use ($summit_id, $request) {
      ...
      $this->promo_code_service->importPromoCodes(
        $summit,
        $file,
        $this->resource_server_context->getCurrentUser(),
      );
  ...
  public function ingestSponsorPromoCodes(LaravelRequest $request, $summit_id) {
    return $this->processRequest(function () use ($summit_id, $request) {
      ...
      $this->promo_code_service->importSponsorPromoCodes(
        $summit,
        $file,
        $this->resource_server_context->getCurrentUser(),
      );
  ...
  public function getPromoCodeSpeakers($summit_id, $promo_code_id) {
    ...
    return $this->_getAll(
      ...
      function () {
        return ["id", "email", "full_name", "email_sent", "redeemed"];
      },
      function ($filter) {
        return $filter;
      },
  ...
  public function sendSponsorPromoCodes($summit_id) {
    return $this->processRequest(function () use ($summit_id) {
      ...
      $payload = $this->getJsonPayload([
        "email_flow_event" =>
          "required|string|in:" . join(",", [SponsorPromoCodeEmail::EVENT_SLUG]),
      ...
      $this->promo_code_service->triggerSendSponsorPromoCodes(
        $summit,
        $payload,
