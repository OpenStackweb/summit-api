 ...
 */
class PresentationSpeakerSelectionProcessAcceptedAlternateEmail extends PresentationSpeakerSelectionProcessEmail
{
    ...
    /**
     * PresentationSpeakerSelectionProcessAcceptedAlternateEmail constructor.
     * @param Summit $summit
