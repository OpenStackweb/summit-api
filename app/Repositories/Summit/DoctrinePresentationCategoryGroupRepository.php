...
final class DoctrinePresentationCategoryGroupRepository
  ...
  protected function getFilterMappings() {
    return [
      ...
      "class_name" => new DoctrineInstanceOfFilterMapping("pcg", [
      ...
      "track_title" => new DoctrineFilterMapping("(cat.title :operator :value)"),
      "track_code" => new DoctrineFilterMapping("(cat.code :operator :value)"),
      "group_title" => new DoctrineFilterMapping("(grp.title :operator :value)"),
      "group_code" => new DoctrineFilterMapping("(grp.code :operator :value)"),
    ];
  }
