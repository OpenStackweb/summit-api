...
trait SummitRegistrationStats {
   ...
   * @throws \Exception
   */
  private static function addDatesFilteringWithTimeZone(
    string $sql,
    string $table,
  ...
  public function getActiveTicketsCount(
    ...
    try {
      ...
      $sql = self::addDatesFilteringWithTimeZone(
        $sql,
   ...
   * @return int
   */
  public function getInactiveTicketsCount(
    ?DateTime $startDate = null,
    ?DateTime $endDate = null,
  ): int {
    try {
   ...
   * @return int
   */
  public function getActiveAssignedTicketsCount(
    ?DateTime $startDate = null,
    ?DateTime $endDate = null,
  ): int {
    try {
   ...
   * @return float
   */
  public function getTotalPaymentAmountCollected(
    ?DateTime $startDate = null,
    ?DateTime $endDate = null,
  ): float {
    try {
   ...
   * @return float
   */
  public function getTotalRefundAmountEmitted(
    ?DateTime $startDate = null,
    ?DateTime $endDate = null,
  ): float {
    try {
   ...
   * @return array
   */
  public function getActiveTicketsCountPerTicketType(
    ?DateTime $startDate = null,
    ?DateTime $endDate = null,
  ): array {
    try {
   ...
   * @return array
   */
  public function getCheckedInActiveTicketsCountPerTicketType(
    ?DateTime $startDate = null,
    ?DateTime $endDate = null,
  ): array {
    try {
   ...
   * @return array
   */
  public function getActiveBadgesCountPerBadgeType(
    ?DateTime $startDate = null,
    ?DateTime $endDate = null,
  ): array {
    try {
   ...
   * @return array
   */
  public function getActiveCheckedInBadgesCountPerBadgeType(
    ?DateTime $startDate = null,
    ?DateTime $endDate = null,
  ): array {
    try {
   ...
   * @return int
   */
  public function getInPersonCheckedInAttendeesCount(
    ?DateTime $startDate = null,
    ?DateTime $endDate = null,
  ): int {
    try {
   ...
   * @return int
   */
  public function getInPersonNonCheckedInAttendeesCount(
    ?DateTime $startDate = null,
    ?DateTime $endDate = null,
  ): int {
    try {
   ...
   * @return int
   */
  public function getVirtualAttendeesCount(
    ?DateTime $startDate = null,
    ?DateTime $endDate = null,
  ): int {
    try {
   ...
   * @return int
   */
  public function getVirtualNonCheckedInAttendeesCount(
    ?DateTime $startDate = null,
    ?DateTime $endDate = null,
  ): int {
    try {
   ...
   * @return array
   */
  public function getActiveTicketsPerBadgeFeatureType(
    ?DateTime $startDate = null,
    ?DateTime $endDate = null,
  ): array {
    try {
   ...
   * @return array
   */
  public function getAttendeesCheckinPerBadgeFeatureType(
    ?DateTime $startDate = null,
    ?DateTime $endDate = null,
  ): array {
    try {
  ...
  public function getAttendeesCheckinsGroupedBy(
    ...
    try {
      ...
      return new PagingResponse($total, $per_page, $page, intval(ceil($total / $per_page)), $res);
    } catch (\Exception $ex) {
      Log::error($ex);
    }
    return new PagingResponse(0, $per_page, $page, 1, []);
  }
