...
final class SummitMediaUploadTypeSerializer extends SilverStripeSerializer {
  ...
  protected static $allowed_relations = ["presentation_types", "summit", "type"];
  ...
  public function serialize(
    ...
    $type = $this->object;
    if (!$type instanceof SummitMediaUploadType) {
      return [];
    }
      ...
      foreach (explode(",", $expand) as $relation) {
        ...
        switch ($relation) {
          ...
          case "presentation_types":
            ...
            foreach ($type->getPresentationTypes() as $presentation_type) {
              $presentation_types[] = SerializerRegistry::getInstance()
                ->getSerializer($presentation_type)
                ->serialize(
                  AbstractSerializer::filterExpandByPrefix($expand, $relation),
                  AbstractSerializer::filterFieldsByPrefix($fields, $relation),
                  AbstractSerializer::filterFieldsByPrefix($relations, $relation),
