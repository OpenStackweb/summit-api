...
class ApiEndpointsSeeder extends Seeder {
  ...
  private function seedAttendeeTicketsEndpoints() {
    ...
    $this->seedApiEndpoints("summits", [
      ...
      [
        ...
        "authz_groups" => [IGroup::BadgePrinters],
      ],
      [
  ...
  private function seedRegistrationOrderEndpoints() {
    ...
    $this->seedApiEndpoints("summits", [
      ...
      [
        ...
        "http_method" => "POST",
        "scopes" => [sprintf(SummitScopes::CreateRegistrationOrders, $current_realm)],
      ],
      [
        "name" => "checkout-registration-order",
        "route" => "/api/v1/summits/{id}/orders/{hash}/checkout",
        "http_method" => "PUT",
        "scopes" => [sprintf(SummitScopes::UpdateMyRegistrationOrders, $current_realm)],
      ],
      [
        "name" => "get-ticket-by-order-hash",
        "route" => "/api/v1/summits/{id}/orders/{hash}/tickets/mine",
        "http_method" => "GET",
        "scopes" => [sprintf(SummitScopes::ReadMyRegistrationOrders, $current_realm)],
      ],
      [
        "name" => "delete-my-registration-order",
        "route" => "/api/v1/summits/{id}/orders/{hash}",
        "http_method" => "DELETE",
        "scopes" => [sprintf(SummitScopes::DeleteMyRegistrationOrders, $current_realm)],
      ],
      [
      ...
      [
        ...
        "http_method" => "GET",
        "scopes" => [sprintf(SummitScopes::ReadMyRegistrationInvitations, $current_realm)],
      ],
      [
  ...
  private function seedSummitEndpoints() {
    ...
    $this->seedApiEndpoints("summits", [
      ...
      [
        ...
        "authz_groups" => [IGroup::SuperAdmins, IGroup::Administrators],
      ],
      [
        "name" => "update-summit",
        "route" => "/api/v1/summits/{id}",
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/sponsors/{sponsor_id}/extra-questions/{extra_question_id}/values",
        "http_method" => "POST",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/sponsors/{sponsor_id}/extra-questions/{extra_question_id}/values/{value_id}",
        "http_method" => "PUT",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "http_method" => "POST",
        "scopes" => [sprintf(SummitScopes::WriteMyBadgeScan, $current_realm)],
      ],
      // sponsorship-types
      [
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/order-extra-questions/{question_id}/sub-question-rules/{rule_id}",
        "http_method" => "PUT",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/badge-types/{badge_type_id}/access-levels/{access_level_id}",
        "http_method" => "PUT",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/badge-types/{badge_type_id}/view-types/{badge_view_type_id}",
        "http_method" => "PUT",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/attendees/{attendee_id}/tickets/{ticket_id}/reassign/{other_member_id}",
        "http_method" => "PUT",
        "scopes" => [
          sprintf(SummitScopes::WriteSummitData, $current_realm),
          sprintf(SummitScopes::WriteAttendeesData, $current_realm),
      ...
      [
        ...
        "route" => "/api/v1/summits/{id}/speakers",
        "http_method" => "POST",
        "scopes" => [sprintf(SummitScopes::WriteSpeakersData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
          IGroup::Administrators,
          IGroup::SummitAdministrators,
      ...
      [
        ...
        "route" => "/api/v1/speakers/me",
        "http_method" => "POST",
        "scopes" => [sprintf(SummitScopes::WriteMySpeakersData, $current_realm)],
      ],
      [
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/speakers/{speaker_id}/presentations/{presentation_id}/feedback",
        "http_method" => "POST",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
      ],
      [
      ...
      [
        ...
        "http_method" => "POST",
        "scopes" => [sprintf(SummitScopes::SendMyScheduleMail, $current_realm)],
        // 5 request per day
        "rate_limit" => 5,
      ...
      [
        ...
        "http_method" => "POST",
        "scopes" => [sprintf(SummitScopes::AddMyEventFeedback, $current_realm)],
      ],
      [
      ...
      [
        ...
        "route" => "/api/v1/summits/{id}/members/{member_id}/schedule/{event_id}/feedback",
        "http_method" => "DELETE",
        "scopes" => [sprintf(SummitScopes::DeleteMyEventFeedback, $current_realm)],
      ],
      [
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/rsvp-templates/{template_id}/questions/{question_id}/values",
        "http_method" => "POST",
        "scopes" => [
          sprintf(SummitScopes::WriteSummitData, $current_realm),
          sprintf(SummitScopes::WriteRSVPTemplateData, $current_realm),
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/rsvp-templates/{template_id}/questions/{question_id}/values/{value_id}",
        "http_method" => "GET",
        "scopes" => [sprintf(SummitScopes::ReadAllSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "http_method" => "GET",
        "scopes" => [sprintf(SummitScopes::ReadMyBookableRoomsReservationData, $current_realm)],
      ],
      [
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/locations/bookable-rooms/all/reservations/{reservation_id}",
        "http_method" => "DELETE",
        "scopes" => [sprintf(SummitScopes::WriteMyBookableRoomsReservationData, $current_realm)],
      ],
      [
        "name" => "refund-bookable-venue-room-reservation",
        "route" =>
          "/api/v1/summits/{id}/locations/bookable-rooms/{room_id}/reservations/{reservation_id}/refund",
        "http_method" => "DELETE",
        "scopes" => [
          sprintf(SummitScopes::WriteSummitData, $current_realm),
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/locations/bookable-rooms/{room_id}/reservations/{reservation_id}/cancel",
        "http_method" => "DELETE",
        "scopes" => [
          sprintf(SummitScopes::WriteSummitData, $current_realm),
          sprintf(SummitScopes::WriteBookableRoomsData, $current_realm),
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/locations/bookable-rooms/{room_id}/reservations/{reservation_id}",
        "http_method" => "GET",
        "scopes" => [
          sprintf(SummitScopes::ReadAllSummitData, $current_realm),
          sprintf(SummitScopes::ReadSummitData, $current_realm),
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/locations/venues/{venue_id}/bookable-rooms/{room_id}/attributes/{attribute_id}",
        "http_method" => "PUT",
        "scopes" => [
          sprintf(SummitScopes::WriteSummitData, $current_realm),
          sprintf(SummitScopes::WriteBookableRoomsData, $current_realm),
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/locations/venues/{venue_id}/floors/{floor_id}/rooms/{room_id}",
        "http_method" => "GET",
        "scopes" => [
          sprintf(SummitScopes::ReadSummitData, $current_realm),
          sprintf(SummitScopes::ReadAllSummitData, $current_realm),
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/locations/venues/{venue_id}/floors/{floor_id}/bookable-rooms/{room_id}",
        "http_method" => "GET",
        "scopes" => [
          sprintf(SummitScopes::ReadBookableRoomsData, $current_realm),
          sprintf(SummitScopes::ReadAllSummitData, $current_realm),
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/locations/venues/{venue_id}/floors/{floor_id}/bookable-rooms",
        "http_method" => "POST",
        "scopes" => [
          sprintf(SummitScopes::WriteBookableRoomsData, $current_realm),
          sprintf(SummitScopes::WriteLocationsData, $current_realm),
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/event-types/{event_type_id}/summit-documents/{document_id}",
        "http_method" => "PUT",
        "scopes" => [
          sprintf(SummitScopes::WriteEventTypeData, $current_realm),
          sprintf(SummitScopes::WriteSummitData, $current_realm),
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/tracks/{track_id}/proposed-schedule-allowed-locations/{location_id}",
        "http_method" => "GET",
        "scopes" => [
          sprintf(SummitScopes::ReadSummitData, $current_realm),
          sprintf(SummitScopes::ReadAllSummitData, $current_realm),
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/tracks/{track_id}/proposed-schedule-allowed-locations/{location_id}/allowed-time-frames",
        "http_method" => "POST",
        "scopes" => [
          sprintf(SummitScopes::WriteTracksData, $current_realm),
          sprintf(SummitScopes::WriteSummitData, $current_realm),
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/tracks/{track_id}/proposed-schedule-allowed-locations/{location_id}/allowed-time-frames/{time_frame_id}",
        "http_method" => "GET",
        "scopes" => [
          sprintf(SummitScopes::ReadSummitData, $current_realm),
          sprintf(SummitScopes::ReadAllSummitData, $current_realm),
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/tracks/{track_id}/proposed-schedule-allowed-locations/{location_id}/allowed-time-frames/all",
        "http_method" => "DELETE",
        "scopes" => [
          sprintf(SummitScopes::WriteTracksData, $current_realm),
          sprintf(SummitScopes::WriteSummitData, $current_realm),
      ...
      [
        ...
        "http_method" => "POST",
        "scopes" => [sprintf(SummitScopes::Allow2PresentationAttendeeVote, $current_realm)],
      ],
      [
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/presentations/{presentation_id}/media-uploads/{media_upload_id}",
        "http_method" => "GET",
        "scopes" => [
          sprintf(SummitScopes::ReadSummitData, $current_realm),
          sprintf(SummitScopes::ReadAllSummitData, $current_realm),
      ...
      [
        ...
        "http_method" => "PUT",
        "scopes" => [sprintf(SummitScopes::EnterEvent, $current_realm)],
      ],
      [
        "name" => "leave-member-from-event",
        "route" => "/api/v1/summits/{id}/members/{member_id}/schedule/{event_id}/leave",
        "http_method" => "POST",
        "scopes" => [sprintf(SummitScopes::LeaveEvent, $current_realm)],
      ],
      //
      [
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/promo-codes/{promo_code_id}/badge-features/{badge_feature_id}",
        "http_method" => "PUT",
        "scopes" => [
          sprintf(SummitScopes::WritePromoCodeData, $current_realm),
          sprintf(SummitScopes::WriteSummitData, $current_realm),
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/speakers-promo-codes/{promo_code_id}/speakers/{speaker_id}",
        "http_method" => "POST",
        "scopes" => [
          sprintf(SummitScopes::WritePromoCodeData, $current_realm),
          sprintf(SummitScopes::WriteSummitData, $current_realm),
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/speakers-discount-codes/{discount_code_id}/speakers/{speaker_id}",
        "http_method" => "POST",
        "scopes" => [
          sprintf(SummitScopes::WritePromoCodeData, $current_realm),
          sprintf(SummitScopes::WriteSummitData, $current_realm),
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/track-groups/{track_group_id}",
        "http_method" => "PUT",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plan-extra-questions/{question_id}/values/{value_id}",
        "http_method" => "PUT",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/extra-questions/metadata",
        "http_method" => "GET",
        "scopes" => [
          sprintf(SummitScopes::ReadAllSummitData, $current_realm),
          sprintf(SummitScopes::ReadSummitData, $current_realm),
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/extra-questions/{question_id}",
        "http_method" => "POST",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
      ],
      [
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/extra-questions/{question_id}/values",
        "http_method" => "POST",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/extra-questions/{question_id}/values/{value_id}",
        "http_method" => "PUT",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/event-types/{event_type_id}",
        "http_method" => "PUT",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/allowed-members/{allowed_member_id}",
        "http_method" => "DELETE",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "http_method" => "GET",
        "scopes" => [sprintf(SummitScopes::ReadSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
          IGroup::Administrators,
          IGroup::TrackChairs,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/presentations/{presentation_id}",
        "http_method" => "GET",
        "scopes" => [sprintf(SummitScopes::ReadSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/presentations/{presentation_id}/actions/{action_type_id}/complete",
        "http_method" => "PUT",
        "scopes" => [
          sprintf(SummitScopes::WriteSummitData, $current_realm),
          sprintf(SummitScopes::WriteEventData, $current_realm),
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/presentations/{presentation_id}/actions/{action_type_id}/incomplete",
        "http_method" => "DELETE",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/presentations/{presentation_id}/comments",
        "http_method" => "POST",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/presentations/{presentation_id}/view",
        "http_method" => "PUT",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/presentations/all/category-change-requests",
        "http_method" => "GET",
        "scopes" => [
          sprintf(SummitScopes::ReadAllSummitData, $current_realm),
          sprintf(SummitScopes::ReadSummitData, $current_realm),
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/presentations/{presentation_id}/category-change-requests",
        "http_method" => "POST",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/presentations/{presentation_id}/category-change-requests/{category_change_request_id}",
        "http_method" => "PUT",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/allowed-presentation-action-types",
        "http_method" => "GET",
        "scopes" => [
          sprintf(SummitScopes::ReadAllSummitData, $current_realm),
          sprintf(SummitScopes::ReadSummitData, $current_realm),
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/allowed-presentation-action-types/{type_id}",
        "http_method" => "GET",
        "scopes" => [sprintf(SummitScopes::ReadSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/presentations/{presentation_id}/track-chair-scores/{score_type_id}",
        "http_method" => "POST",
        "scopes" => [
          sprintf(SummitScopes::WriteSummitData, $current_realm),
          sprintf(SummitScopes::WriteEventData, $current_realm),
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/track-tag-groups/{track_tag_group_id}/allowed-tags/all/copy/tracks/{track_id}",
        "http_method" => "POST",
        "scopes" => [
          sprintf(SummitScopes::WriteSummitData, $current_realm),
          sprintf(SummitScopes::WriteTracksData, $current_realm),
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/summit-documents/{document_id}/event-types/{event_type_id}",
        "http_method" => "PUT",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/media-upload-types/{media_upload_type_id}/presentation-types/{event_type_id}",
        "http_method" => "PUT",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/tracks/{track_id}/selection-lists/individual/owner/me",
        "http_method" => "POST",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/tracks/{track_id}/selection-lists/individual/owner/{owner_id}",
        "http_method" => "GET",
        "scopes" => [sprintf(SummitScopes::ReadSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/tracks/{track_id}/selection-lists/individual/presentation-selections/{collection}/presentations/{presentation_id}",
        "http_method" => "POST",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/tracks/{track_id}/selection-lists/team",
        "http_method" => "GET",
        "scopes" => [sprintf(SummitScopes::ReadSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/tracks/{track_id}/selection-lists/{list_id}/reorder",
        "http_method" => "PUT",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/track-chair-rating-types",
        "http_method" => "GET",
        "scopes" => [sprintf(SummitScopes::ReadSummitData, $current_realm)],
      ],
      [
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/track-chair-rating-types/{type_id}",
        "http_method" => "GET",
        "scopes" => [sprintf(SummitScopes::ReadSummitData, $current_realm)],
      ],
      [
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/track-chair-rating-types/{type_id}/score-types",
        "http_method" => "GET",
        "scopes" => [sprintf(SummitScopes::ReadSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/selection-plans/{selection_plan_id}/track-chair-rating-types/{type_id}/score-types/{score_type_id}",
        "http_method" => "GET",
        "scopes" => [sprintf(SummitScopes::ReadSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "route" =>
          "/api/v1/summits/{id}/proposed-schedules/{source}/presentations/{presentation_id}/propose",
        "http_method" => "PUT",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
      ...
      [
        ...
        "http_method" => "POST",
        "scopes" => [sprintf(SummitScopes::WriteSummitData, $current_realm)],
        "authz_groups" => [IGroup::TrackChairs, IGroup::TrackChairsAdmins],
      ],
      [
  ...
  private function seedAuditLogEndpoints() {
    ...
    $this->seedApiEndpoints("audit-logs", [
      [
        ...
        "http_method" => "GET",
        "scopes" => [sprintf(SummitScopes::ReadAuditLogs, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
          IGroup::Administrators,
          IGroup::TrackChairsAdmins,
  ...
  private function seedApiEndpoints($api_name, array $endpoints_info) {
    $api = EntityManager::getRepository(\App\Models\ResourceServer\Api::class)->findOneBy([
      "name" => $api_name,
    ]);
    if (is_null($api)) {
      return;
    ...
    foreach ($endpoints_info as $endpoint_info) {
      ...
      foreach ($endpoint_info["scopes"] as $scope_name) {
        $scope = EntityManager::getRepository(
          \App\Models\ResourceServer\ApiScope::class,
        )->findOneBy(["name" => $scope_name]);
        if (is_null($scope)) {
          continue;
        }
  ...
  private function seedMemberEndpoints() {
    ...
    $this->seedApiEndpoints("members", [
      ...
      [
        ...
        "route" => "/api/v1/members/{member_id}/affiliations",
        "http_method" => "POST",
        "scopes" => [sprintf(MemberScopes::WriteMemberData, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
          IGroup::Administrators,
          IGroup::SummitAdministrators,
  ...
  private function seedCompaniesEndpoints() {
    ...
    $this->seedApiEndpoints("companies", [
      ...
      [
        ...
        "route" => "/api/v1/companies",
        "http_method" => "POST",
        "scopes" => [sprintf(CompanyScopes::Write, $current_realm)],
        "authz_groups" => [IGroup::SuperAdmins, IGroup::Administrators],
      ],
      [
        "name" => "update-company",
      ...
      [
        ...
        "route" => "/api/v1/companies/{id}",
        "http_method" => "GET",
        "scopes" => [sprintf(CompanyScopes::Read, $current_realm)],
      ],
      [
  ...
  private function seedSponsoredProjectsEndpoints() {
    ...
    $this->seedApiEndpoints("sponsored-projects", [
      [
        ...
        "http_method" => "GET",
        "scopes" => [sprintf(SponsoredProjectScope::Read, $current_realm)],
      ],
      [
        "name" => "add-sponsored-projects",
        "route" => "/api/v1/sponsored-projects",
        "http_method" => "POST",
        "scopes" => [sprintf(SponsoredProjectScope::Write, $current_realm)],
        "authz_groups" => [IGroup::SuperAdmins, IGroup::Administrators],
      ],
      [
      ...
      [
        ...
        "route" =>
          "/api/v1/sponsored-projects/{id}/sponsorship-types/{sponsorship_type_id}/supporting-companies",
        "http_method" => "GET",
        "scopes" => [sprintf(SponsoredProjectScope::Read, $current_realm)],
      ],
      [
      ...
      [
        ...
        "route" =>
          "/api/v1/sponsored-projects/{id}/sponsorship-types/{sponsorship_type_id}/supporting-companies/{company_id}",
        "http_method" => "PUT",
        "scopes" => [sprintf(SponsoredProjectScope::Write, $current_realm)],
        "authz_groups" => [IGroup::SuperAdmins, IGroup::Administrators],
      ],
  ...
  private function seedOrganizationsEndpoints() {
    ...
    $this->seedApiEndpoints("organizations", [
      ...
      [
        ...
        "http_method" => "GET",
        "scopes" => [sprintf(OrganizationScopes::ReadOrganizationData, $current_realm)],
      ],
    ]);
    ...
    $this->seedApiEndpoints("organizations", [
      ...
      [
        ...
        "route" => "/api/v1/organizations",
        "http_method" => "POST",
        "scopes" => [sprintf(OrganizationScopes::WriteOrganizationData, $current_realm)],
      ],
    ]);
  }
  ...
  public function seedTrackQuestionTemplateEndpoints() {
    ...
    $this->seedApiEndpoints("track-question-templates", [
      ...
      [
        ...
        "http_method" => "POST",
        "scopes" => [sprintf(SummitScopes::WriteBadgeScan, $current_realm)],
        "authz_groups" => [
          IGroup::SuperAdmins,
          IGroup::Administrators,
          IGroup::SummitAdministrators,
      ...
      [
        ...
        "http_method" => "GET",
        "scopes" => [sprintf(SummitScopes::ReadMyBadgeScan, $current_realm)],
      ],
      [
  ...
  public function seedSummitAdministratorGroupsEndpoints() {
    ...
    $this->seedApiEndpoints("summit-administrator-groups", [
      [
        ...
        "http_method" => "GET",
        "scopes" => [sprintf(SummitScopes::ReadSummitAdminGroups, $current_realm)],
        "authz_groups" => [IGroup::SuperAdmins, IGroup::Administrators],
      ],
      [
      ...
      [
        ...
        "route" => "/api/v1/summit-administrator-groups",
        "http_method" => "POST",
        "scopes" => [sprintf(SummitScopes::WriteSummitAdminGroups, $current_realm)],
        "authz_groups" => [IGroup::SuperAdmins, IGroup::Administrators],
      ],
      [
  ...
  public function seedSummitMediaFileTypeEndpoints() {
    ...
    $this->seedApiEndpoints("summit-media-file-types", [
      ...
      [
        ...
        "route" => "/api/v1/summits/{id}/metrics/onsite/enter",
        "http_method" => "PUT",
        "scopes" => [sprintf(SummitScopes::WriteMetrics, $current_realm)],
        "authz_groups" => [IGroup::SummitAccessControl],
      ],
      [
  ...
  public function seedElectionsEndpoints() {
    $this->seedApiEndpoints("elections", [
      [
        ...
        "http_method" => "GET",
        "scopes" => [ElectionScopes::ReadAllElections],
      ],
      [
      ...
      [
        ...
        "http_method" => "PUT",
        "scopes" => [ElectionScopes::WriteMyCandidateProfile],
      ],
      [
        "name" => "nominate-candidate",
        "route" => "/api/v1/elections/current/candidates/{candidate_id}",
        "http_method" => "POST",
        "scopes" => [ElectionScopes::NominatesCandidates],
      ],
    ]);
  }
}
