...
/**
 * Class ProcessSpeakersEmailRequestJobTest
 *
 ...
 */
final class ProcessSpeakersEmailRequestJobTest extends TestCase
{
    ...
    {
        return ['email_flow_event' => 'SUMMIT_SUBMISSIONS_PRESENTATION_SPEAKER_ACCEPTED_ONLY'];
    }
    ...
    public function testHandleAcceptsHasPublishedPresentationsTrueFilter(): void
    {
        ...
        $job = new ProcessSpeakersEmailRequestJob(
            999,
            $this->makePayload(),
