 ...
 */
final class DoctrineSummitOrderRepository extends SilverStripeDoctrineRepository implements
  ISummitOrderRepository {
  /**
   * @return array
   */
  protected function getFilterMappings() {
    return [
      ...
      "ticket_owner_name" =>
        "COALESCE(LOWER(CONCAT(to.first_name, ' ', to.surname)), LOWER(CONCAT(tom.first_name, ' ', tom.last_name)))",
