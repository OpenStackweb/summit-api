 ...
 */
final class SummitLocationService extends AbstractService implements ILocationService {
  /**
    ...
    $location = $this->tx_service->transaction(function () use ($summit, $data) {
      ...
      if (!is_null($old_location)) {
        throw new ValidationException(
          trans("validation_errors.LocationService.addLocation.LocationNameAlreadyExists", [
      ...
      if (is_null($location)) {
        throw new ValidationException(
          trans("validation_errors.LocationService.addLocation.InvalidClassName"),
        );
      }
      ...
      if ($location instanceof SummitGeoLocatedLocation) {
        try {
          ...
          $validation_msg = trans(
            "validation_errors.LocationService.addLocation.geoCodingGenericError",
          );
          switch ($ex1->getStatus()) {
            case IGeoCodingAPI::ResponseStatusZeroResults:
              $validation_msg = trans(
                "validation_errors.LocationService.addLocation.InvalidAddressOrCoordinates",
              );
              break;
            case IGeoCodingAPI::ResponseStatusOverQueryLimit:
              $validation_msg = trans(
                "validation_errors.LocationService.addLocation.OverQuotaLimit",
              );
              break;
          }
    ...
    return $this->tx_service->transaction(function () use ($summit, $location_id, $data) {
      if (isset($data["name"])) {
        ...
        if (!is_null($old_location) && $old_location->getId() != $location_id) {
          throw new ValidationException(
            trans("validation_errors.LocationService.updateLocation.LocationNameAlreadyExists", [
              "summit_id" => $summit->getId(),
            ]),
          );
        }
      ...
      if (is_null($location)) {
        throw new EntityNotFoundException(
          trans("validation_errors.LocationService.updateLocation.LocationNotFoundOnSummit", [
            "summit_id" => $summit->getId(),
      ...
      if ($location->getClassName() != $data["class_name"]) {
        throw new ValidationException(
          trans("validation_errors.LocationService.updateLocation.ClassNameMissMatch", [
            "summit_id" => $summit->getId(),
            "location_id" => $location_id,
      ...
      if (
        $location instanceof SummitGeoLocatedLocation &&
        $this->hasGeoLocationData2Update($data)
      ) {
        try {
          $geo_location_strategy = GeoLocationStrategyFactory::build($location);
          $geo_location_strategy->doGeoLocation($location, $this->geo_coding_api);
  ...
  public function deleteLocation(Summit $summit, $location_id) {
    return $this->tx_service->transaction(function () use ($summit, $location_id) {
      ...
      if (is_null($location)) {
        throw new EntityNotFoundException(
          trans("validation_errors.LocationService.deleteLocation.LocationNotFoundOnSummit", [
            "summit_id" => $summit->getId(),
            "location_id" => $location_id,
          ]),
        );
  ...
  public function addVenueFloor(Summit $summit, $venue_id, array $data) {
    return $this->tx_service->transaction(function () use ($summit, $venue_id, $data) {
      ...
      if (is_null($venue)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.addVenueFloor.VenueNotFound", [
            "summit_id" => $summit->getId(),
            "venue_id" => $venue_id,
          ]),
        );
      ...
      if (!is_null($former_floor)) {
        throw new ValidationException(
          trans("validation_errors.LocationService.addVenueFloor.FloorNameAlreadyExists", [
            "venue_id" => $venue_id,
      ...
      if (!is_null($former_floor)) {
        throw new ValidationException(
          trans("validation_errors.LocationService.addVenueFloor.FloorNumberAlreadyExists", [
            "venue_id" => $venue_id,
  ...
  public function updateVenueFloor(Summit $summit, $venue_id, $floor_id, array $data) {
    return $this->tx_service->transaction(function () use ($summit, $venue_id, $floor_id, $data) {
      ...
      if (is_null($venue)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.updateVenueFloor.VenueNotFound", [
            "summit_id" => $summit->getId(),
            "venue_id" => $venue_id,
          ]),
        );
      ...
      if (is_null($floor)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.updateVenueFloor.FloorNotFound", [
            "floor_id" => $floor_id,
            "venue_id" => $venue_id,
          ]),
        );
  ...
  public function deleteVenueFloor(Summit $summit, $venue_id, $floor_id) {
    return $this->tx_service->transaction(function () use ($summit, $venue_id, $floor_id) {
      ...
      if (is_null($venue)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.deleteVenueFloor.VenueNotFound", [
            "summit_id" => $summit->getId(),
            "venue_id" => $venue_id,
          ]),
        );
      ...
      if (is_null($floor)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.deleteVenueFloor.FloorNotFound", [
            "floor_id" => $floor_id,
            "venue_id" => $venue_id,
          ]),
        );
  ...
  public function addVenueRoom(Summit $summit, $venue_id, array $data) {
    $room = $this->tx_service->transaction(function () use ($summit, $venue_id, $data) {
      if (isset($data["name"])) {
        ...
        if (!is_null($old_location)) {
          throw new ValidationException(
            trans("validation_errors.LocationService.addVenueRoom.LocationNameAlreadyExists", [
              "summit_id" => $summit->getId(),
            ]),
          );
        }
      ...
      if (is_null($venue)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.addVenueRoom.VenueNotFound", [
            "summit_id" => $summit->getId(),
            "venue_id" => $venue_id,
          ]),
        );
      ...
      if (is_null($room)) {
        throw new ValidationException(
          trans("validation_errors.LocationService.addVenueRoom.InvalidClassName"),
        );
      }
      ...
      if (isset($data["floor_id"])) {
        ...
        if (is_null($floor)) {
          throw new EntityNotFoundException(
            trans("not_found_errors.LocationService.addVenueRoom.FloorNotFound", [
              "floor_id" => $floor_id,
              "venue_id" => $venue_id,
            ]),
          );
    ...
    return $this->tx_service->transaction(function () use ($summit, $venue_id, $room_id, $data) {
      if (isset($data["name"])) {
        ...
        if (!is_null($old_location) && $old_location->getId() != $room_id) {
          throw new ValidationException(
            trans("validation_errors.LocationService.updateVenueRoom.LocationNameAlreadyExists", [
              "summit_id" => $summit->getId(),
            ]),
          );
        }
      ...
      if (is_null($venue)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.updateVenueRoom.VenueNotFound", [
            "summit_id" => $summit->getId(),
            "venue_id" => $venue_id,
          ]),
        );
      ...
      if (is_null($room)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.updateVenueRoom.RoomNotFound", [
            "summit_id" => $summit->getId(),
            "venue_id" => $venue_id,
            "room_id" => $room_id,
          ]),
      ...
      if (isset($data["floor_id"])) {
        ...
        if ($old_floor_id != $new_floor_id) {
          ...
          if (is_null($floor)) {
            throw new EntityNotFoundException(
              trans("not_found_errors.LocationService.updateVenueRoom.FloorNotFound", [
  ...
  public function deleteVenueRoom(Summit $summit, $venue_id, $room_id) {
    return $this->tx_service->transaction(function () use ($summit, $venue_id, $room_id) {
      ...
      if (is_null($venue)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.deleteVenueRoom.VenueNotFound", [
            "summit_id" => $summit->getId(),
            "venue_id" => $venue_id,
          ]),
        );
      ...
      if (is_null($room)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.deleteVenueRoom.RoomNotFound", [
            "room_id" => $room_id,
            "venue_id" => $venue_id,
          ]),
        );
  ...
  public function addLocationBanner(Summit $summit, $location_id, array $data) {
    return $this->tx_service->transaction(function () use ($summit, $location_id, $data) {
      ...
      if (is_null($location)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.addLocationBanner.LocationNotFound", [
            "summit_id" => $summit->getId(),
            "location_id" => $location_id,
          ]),
        );
      ...
      if (is_null($banner)) {
        throw new ValidationException(
          trans("validation_errors.LocationService.addLocationBanner.InvalidClassName"),
        );
      }
  ...
  public function updateLocationBanner(Summit $summit, $location_id, $banner_id, array $data) {
    return $this->tx_service->transaction(function () use (
      ...
      if (is_null($location)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.updateLocationBanner.LocationNotFound", [
            "summit_id" => $summit->getId(),
            "location_id" => $location_id,
          ]),
        );
      ...
      if (is_null($banner)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.updateLocationBanner.BannerNotFound", [
            "location_id" => $location_id,
            "banner_id" => $banner_id,
          ]),
        );
  ...
  public function deleteLocationBanner(Summit $summit, $location_id, $banner_id) {
    return $this->tx_service->transaction(function () use ($summit, $location_id, $banner_id) {
      ...
      if (is_null($location)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.deleteLocationBanner.LocationNotFound", [
            "summit_id" => $summit->getId(),
            "location_id" => $location_id,
          ]),
        );
      ...
      if (is_null($banner)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.deleteLocationBanner.BannerNotFound", [
            "location_id" => $location_id,
            "banner_id" => $banner_id,
          ]),
        );
  ...
  public function addLocationMap(
    ...
    return $this->tx_service->transaction(function () use (
      ...
      if (is_null($location)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.addLocationMap.LocationNotFound", [
            "location_id" => $location_id,
          ]),
        );
      }
      ...
      if (!in_array($file->extension(), $allowed_extensions)) {
        throw new ValidationException(
          trans("validation_errors.LocationService.addLocationMap.FileNotAllowedExtension", [
      ...
      if ($file->getSize() > $max_file_size) {
        throw new ValidationException(
          trans("validation_errors.LocationService.addLocationMap.FileMaxSize", [
            "max_file_size" => $max_file_size / 1024 / 1024,
          ]),
        );
      }

      $pic = $this->file_uploader->build(
        $file,
        sprintf("summits/%s/locations/%s/maps", $location->getSummitId(), $location->getId()),
        true,
      );
   ...
   * @throws ValidationException
   */
  public function updateLocationMap(
    Summit $summit,
    $location_id,
    $map_id,
    array $metadata,
    ...
    return $this->tx_service->transaction(function () use (
      ...
      if (is_null($location)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.updateLocationMap.LocationNotFound", [
            "location_id" => $location_id,
          ]),
        );
      }
      ...
      if (is_null($map)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.updateLocationMap.MapNotFound", [
            "map_id" => $map_id,
            "location_id" => $location_id,
          ]),
        );
      ...
      if (!is_null($file)) {
        if (!in_array($file->extension(), $allowed_extensions)) {
          throw new ValidationException(
            trans("validation_errors.LocationService.updateLocationMap.FileNotAllowedExtension", [
              "allowed_extensions" => implode(", ", $allowed_extensions),
            ]),
          );
        }
        ...
        if ($file->getSize() > $max_file_size) {
          throw new ValidationException(
            trans("validation_errors.LocationService.updateLocationMap.FileMaxSize", [
              "max_file_size" => $max_file_size / 1024 / 1024,
            ]),
          );
        }
  ...
  public function deleteLocationMap(Summit $summit, $location_id, $map_id) {
    return $this->tx_service->transaction(function () use ($summit, $location_id, $map_id) {
      ...
      if (is_null($location)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.deleteLocationMap.LocationNotFound", [
            "summit_id" => $summit->getId(),
            "location_id" => $location_id,
          ]),
        );
      ...
      if (is_null($map)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.deleteLocationMap.MapNotFound", [
            "location_id" => $location_id,
            "map_id" => $map_id,
          ]),
        );
   ...
   * @throws ValidationException
   */
  public function addLocationImage(
    Summit $summit,
    $location_id,
    array $metadata,
    UploadedFile $file,
  ) {
    $image = $this->tx_service->transaction(function () use (
      $summit,
      $location_id,
      $metadata,
      $file,
      ...
      if (is_null($location)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.addLocationImage.LocationNotFound", [
            "location_id" => $location_id,
          ]),
        );
      }
      ...
      if (!in_array($file->extension(), $allowed_extensions)) {
        throw new ValidationException(
          trans("validation_errors.LocationService.addLocationImage.FileNotAllowedExtension", [
            "allowed_extensions" => implode(", ", $allowed_extensions),
          ]),
        );
      }
      ...
      if ($file->getSize() > $max_file_size) {
        throw new ValidationException(
          trans("validation_errors.LocationService.addLocationImage.FileMaxSize", [
            "max_file_size" => $max_file_size / 1024 / 1024,
          ]),
        );
      }
      ...
      $pic = $this->file_uploader->build(
        $file,
        sprintf("summits/%s/locations/%s/images", $location->getSummitId(), $location->getId()),
        true,
      );
  ...
  public function updateLocationImage(
    ...
    return $this->tx_service->transaction(function () use (
      ...
      if (is_null($location)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.updateLocationImage.LocationNotFound", [
            "location_id" => $location_id,
          ]),
        );
      }
      ...
      if (is_null($image)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.updateLocationImage.ImageNotFound", [
            "image_id" => $image,
            "location_id" => $location_id,
          ]),
        );
      ...
      if (!is_null($file)) {
        if (!in_array($file->extension(), $allowed_extensions)) {
          throw new ValidationException(
            trans("validation_errors.LocationService.updateLocationImage.FileNotAllowedExtension", [
              "allowed_extensions" => implode(", ", $allowed_extensions),
            ]),
          );
        }
        ...
        if ($file->getSize() > $max_file_size) {
          throw new ValidationException(
            trans("validation_errors.LocationService.updateLocationImage.FileMaxSize", [
              "max_file_size" => $max_file_size / 1024 / 1024,
            ]),
          );
        }
  ...
  public function deleteLocationImage(Summit $summit, $location_id, $image_id) {
    return $this->tx_service->transaction(function () use ($summit, $location_id, $image_id) {
      ...
      if (is_null($location)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.deleteLocationImage.LocationNotFound", [
            "summit_id" => $summit->getId(),
            "location_id" => $location_id,
          ]),
        );
      ...
      if (is_null($image)) {
        throw new EntityNotFoundException(
          trans("not_found_errors.LocationService.deleteLocationImage.ImageNotFound", [
            "location_id" => $location_id,
            "image_id" => $image_id,
          ]),
        );
   ...
   * @throws ValidationException
   */
  public function addBookableRoomReservation(
    Summit $summit,
    int $room_id,
    array $payload,
    ...
    $reservation = $this->tx_service->transaction(function () use ($summit, $room_id, $payload) {
      ...
      if (
        $owner->getReservationsCountBySummit($summit) >= $summit->getMeetingRoomBookingMaxAllowed()
      ) {
        throw new ValidationException(
          sprintf(
      ...
      if ($room->getCurrency() != $currency) {
        throw new ValidationException(
          sprintf("Currency set %s is not allowed for room %s.", $currency, $room->getId()),
        );
      }
   ...
   * @throws ValidationException
   */
  public function addOfflineBookableRoomReservation(
    Summit $summit,
    int $room_id,
    array $payload,
  ): SummitRoomReservation {
  ...
  public function processPayment(array $payload, ?Summit $summit = null): void {
    $this->tx_service->transaction(function () use ($summit, $payload) {
      ...
      $reservation = $this->reservation_repository->getByPaymentGatewayCartIdExclusiveLock(
        $payload["cart_id"],
      );

      if (is_null($reservation)) {
        throw new EntityNotFoundException(
          sprintf("There is no reservation with cart_id %s.", $payload["cart_id"]),
        );
      }
  ...
  public function cancelReservation(
    ...
    return $this->tx_service->transaction(function () use ($summit, $owner, $reservation_id) {
      ...
      if (
        $reservation->getStatus() == SummitRoomReservation::RequestedRefundStatus ||
  ...
  public function refundReservation(
    ...
    return $this->tx_service->transaction(function () use ($room, $reservation_id, $amount) {
      ...
      $validStatuses = [
        ...
        SummitRoomReservation::PaidStatus,
      ];
      if (!in_array($status, $validStatuses)) {
        throw new ValidationException(
          sprintf("Can not request a refund on a %s booking.", $status),
        );
      }
      ...
      try {
        $payment_gateway->refundPayment(
          $reservation->getPaymentGatewayCartId(),
          $amount,
   ...
   * @throws ValidationException
   */
  public function addVenueBookableRoomAttribute(
    Summit $summit,
    int $venue_id,
    int $room_id,
    int $attribute_id,
  ): SummitBookableVenueRoom {
    return $this->tx_service->transaction(function () use (
      $summit,
      $venue_id,
      $room_id,
   ...
   * @throws ValidationException
   */
  public function deleteVenueBookableRoomAttribute(
    Summit $summit,
    int $venue_id,
    int $room_id,
    int $attribute_id,
  ...
  public function addRoomImage(
    ...
    return $this->tx_service->transaction(function () use (
      ...
      $image = $this->file_uploader->build(
        $file,
        sprintf("summits/%s/locations/%s/rooms", $summit->getId(), $venue_id),
        true,
      );
      $room->setImage($image);
    ...
    foreach ($reservations as $reservation) {
      $this->tx_service->transaction(function () use ($reservation) {
        try {
          ...
          Log::debug(
            sprintf(
              "[SummitLocationService::revokeBookableRoomsReservedOlderThanNMinutes] cancelling reservation %s created at %s",
              $reservation->getId(),
              $reservation->getCreated()->format("Y-m-d h:i:sa"),
            ),
          );
          ...
          if (!is_null($status)) {
            Log::debug(
              sprintf(
                "[SummitLocationService::revokeBookableRoomsReservedOlderThanNMinutes] got status %s for reservation %s",
                $status,
                $reservation->getId(),
              ),
            );
            if (!$payment_gateway->canAbandon($status)) {
              Log::warning(
                sprintf(
                  "[SummitLocationService::revokeBookableRoomsReservedOlderThanNMinutes] reservation %s created at %s can not be cancelled external status %s",
                  $reservation->getId(),
                  $reservation->getCreated()->format("Y-m-d h:i:sa"),
                  $status,
                ),
              ...
              if ($payment_gateway->isSucceeded($status)) {
                Log::debug(
                  sprintf(
                    "[SummitLocationService::revokeBookableRoomsReservedOlderThanNMinutes] set reservation %s as paid",
                    $status,
                    $reservation->getId(),
                  ),
                );
          ...
          Log::debug(
            sprintf(
              "[SummitLocationService::revokeBookableRoomsReservedOlderThanNMinutes] reservation %s created at %s canceled",
              $reservation->getId(),
              $reservation->getCreated()->format("Y-m-d h:i:sa"),
            ),
          );
  ...
  public function addFloorImage(
    ...
    return $this->tx_service->transaction(function () use (
      ...
      $image = $this->file_uploader->build(
        $file,
        sprintf("summits/%s/locations/%s/floors", $summit->getId(), $venue_id),
        true,
      );
  ...
  public function updateBookableRoomReservation(
    $summit,
    int $room_id,
    int $reservation_id,
    array $payload,
  ): SummitRoomReservation {
    $reservation = $this->tx_service->transaction(function () use (
      $summit,
      $room_id,
      $reservation_id,
      $payload,
