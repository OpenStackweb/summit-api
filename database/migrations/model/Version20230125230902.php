...
/**
 * Class Version20230125230902
 * @package Database\Migrations\Model
 */
final class Version20230125230902 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema): void
    {
        ...
        SummitEmailFlowTypeSeeder::createEventsTypes(
            [
                ...
                [
                    'name' => ReInviteSubmissionEmail::EVENT_NAME,
                    'slug' => ReInviteSubmissionEmail::EVENT_SLUG,
                    'default_email_template' => ReInviteSubmissionEmail::DEFAULT_TEMPLATE
                ],
            ],
            $flow
        );
