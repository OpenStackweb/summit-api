 ...
 */
class InviteSubmissionEmail extends AbstractSummitEmailJob {
  /**
  ...
  public function __construct(SummitSubmissionInvitation $invitation, array $extra_data) {
    ...
    if (isset($extra_data[IMailTemplatesConstants::selection_plan_id])) {
      ...
      Log::debug(
        sprintf(
          "InviteSubmissionEmail::____construct selection plan %s was provided",
          $selection_plan_id,
        ),
      );
      ...
      $payload[IMailTemplatesConstants::selection_plan_submission_start_date] = !is_null(
        $submissionBeingDateLocal,
      )
        ? $submissionBeingDateLocal->format("F d, Y")
        : "";
      $submissionEndDateLocal = $selection_plan->getSubmissionEndDateLocal();
      $payload[IMailTemplatesConstants::selection_plan_submission_end_date] = !is_null(
        $submissionEndDateLocal,
      )
