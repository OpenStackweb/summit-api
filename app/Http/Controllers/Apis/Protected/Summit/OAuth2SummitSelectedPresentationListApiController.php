 ...
 */
class OAuth2SummitSelectedPresentationListApiController extends OAuth2ProtectedController {
  ...
  public function createTeamSelectionList($summit_id, $selection_plan_id, $track_id) {
    return $this->processRequest(function () use ($summit_id, $selection_plan_id, $track_id) {
      ...
      $selection_list = $this->service->createTeamSelectionList(
        $summit,
        intval($selection_plan_id),
        intval($track_id),
      );
  ...
  public function getIndividualSelectionList($summit_id, $selection_plan_id, $track_id, $owner_id) {
    return $this->processRequest(function () use (
      ...
      $selection_list = $this->service->getIndividualSelectionList(
        $summit,
        intval($selection_plan_id),
        intval($track_id),
        intval($owner_id),
  ...
  public function createIndividualSelectionList($summit_id, $selection_plan_id, $track_id) {
    return $this->processRequest(function () use ($summit_id, $selection_plan_id, $track_id) {
      ...
      $selection_list = $this->service->createIndividualSelectionList(
        $summit,
        intval($selection_plan_id),
        intval($track_id),
        $this->resource_server_context->getCurrentUserId(),
      );
  ...
  public function reorderSelectionList($summit_id, $selection_plan_id, $track_id, $list_id) {
    return $this->processRequest(function () use (
      ...
      $selection_list = $this->service->reorderList(
        $summit,
        intval($selection_plan_id),
        intval($track_id),
        intval($list_id),
