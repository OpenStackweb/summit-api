 ...
 */
final class DoctrineSummitEntityEventRepository extends SilverStripeDoctrineRepository implements
  ISummitEntityEventRepository {
  /**
   * @param Summit $summit
  ...
  public function getEntityEvents(
    ...
    if ($detach) {
      $this->getEntityManager()->clear(\models\summit\SummitEntityEvent::class);
    }
