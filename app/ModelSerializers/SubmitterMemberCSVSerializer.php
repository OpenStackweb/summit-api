...
final class SubmitterMemberCSVSerializer extends AdminMemberSerializer
{
    ...
    public function serialize($expand = null, array $fields = [], array $relations = [], array $params = []) : array
    {
        ...
        if (in_array('accepted_presentations', $relations) && !is_null($summit)) {
            $accepted_presentations = $submitter->getAcceptedPresentations($summit,$params['filter'] ?? null);
        ...
        if (in_array('alternate_presentations', $relations) && !is_null($summit)) {
            $alternate_presentations = $submitter->getAlternatePresentations($summit,$params['filter'] ?? null);
        ...
        if (in_array('rejected_presentations', $relations) && !is_null($summit)) {
            $rejected_presentations = $submitter->getRejectedPresentations($summit,$params['filter'] ?? null);
