 ...
 */
final class DoctrineSpeakerRepository extends SilverStripeDoctrineRepository implements
  ISpeakerRepository {
  /**
   * @return array
   */
    ...
    return [
      ...
      "presentations_selection_plan_id" => new DoctrineFilterMapping(
        'EXISTS ( 
          ...
          (!empty($extraSelectionPlanFilter) ? sprintf($extraSelectionPlanFilter, "52") : "") .
          ")",
      ),
      ...
      "has_accepted_presentations" => new DoctrineSwitchFilterMapping([
        "true" => new DoctrineCaseFilterMapping(
          ...
          sprintf(
            ...
            (!empty($extraSelectionStatusFilter)
              ? sprintf($extraSelectionStatusFilter, "14")
              : " ") .
            ")",
        ),
      ...
      "has_alternate_presentations" => new DoctrineSwitchFilterMapping([
        "true" => new DoctrineCaseFilterMapping(
          ...
          sprintf(
            ...
            (!empty($extraSelectionStatusFilter)
              ? sprintf($extraSelectionStatusFilter, "22")
              : " ") .
            ")",
        ),
        "false" => new DoctrineCaseFilterMapping(
          ...
          sprintf(
            ...
            sprintf(
              'EXISTS (
                ...
                (!empty($extraSelectionStatusFilter)
                  ? sprintf($extraSelectionStatusFilter, "32")
                  : " ") .
                'AND NOT EXISTS  (
                                            SELECT ___sp32.id 
