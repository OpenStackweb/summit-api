...
final class SummitScheduleConfigFactory {
  ...
  public static function populate(
    SummitScheduleConfig $config,
    array $payload,
    ISummitScheduleConfigRepository $repository = null,
  ): SummitScheduleConfig {
    ...
    if (isset($payload["only_events_with_attendee_access"])) {
      $config->setOnlyEventsWithAttendeeAccess(
        boolval($payload["only_events_with_attendee_access"]),
      );
    }
    ...
    if (isset($payload["hide_past_events_with_show_always_on_schedule"])) {
      $config->setHidePastEventsWithShowAlwaysOnSchedule(
        boolval($payload["hide_past_events_with_show_always_on_schedule"]),
      );
    }
