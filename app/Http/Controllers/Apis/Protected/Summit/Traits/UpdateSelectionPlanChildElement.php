...
use Exception;
/**
 * Trait UpdateSelectionPlanChildElement
...
trait UpdateSelectionPlanChildElement
{
     ...
     * @return IEntity
     */
    abstract protected function updateChild(SelectionPlan $selection_plan, int $child_id, array $payload):IEntity;
     ...
     * @return mixed
     */
    public function update($summit_id, $selection_plan_id, $child_id){
        try {
            ...
            $child = $this->updateChild($selection_plan, $child_id, $payload);
