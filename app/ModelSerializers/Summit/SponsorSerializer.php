...
final class SponsorSerializer extends SilverStripeSerializer {
  ...
  protected static $allowed_relations = ["extra_questions", "members"];
      ...
      foreach ($exp_expand as $relation) {
        ...
        switch ($relation) {
          case "summit":
            ...
            if (
              $current_member instanceof Member &&
            ...
            $values["summit"] = SerializerRegistry::getInstance()
              ...
              ->serialize(AbstractSerializer::filterExpandByPrefix($expand, "summit"), $fields, [
                "none",
              ]);
            break;
          ...
          case "company":
            if ($sponsor->hasCompany()) {
              ...
              $values["company"] = SerializerRegistry::getInstance()
                ->getSerializer($sponsor->getCompany(), SerializerRegistry::SerializerType_Admin)
                ->serialize(
                  AbstractSerializer::filterExpandByPrefix($expand, $relation),
                  AbstractSerializer::filterFieldsByPrefix($fields, $relation),
                  AbstractSerializer::filterFieldsByPrefix($relations, $relation),
          ...
          case "sponsorship":
            if ($sponsor->hasSponsorship()) {
              ...
              $values["sponsorship"] = SerializerRegistry::getInstance()
                ->getSerializer($sponsor->getSponsorship())
                ->serialize(
                  AbstractSerializer::filterExpandByPrefix($expand, $relation),
                  AbstractSerializer::filterFieldsByPrefix($fields, $relation),
                  AbstractSerializer::filterFieldsByPrefix($relations, $relation),
          ...
          case "featured_event":
            if ($sponsor->hasFeaturedEvent()) {
              ...
              $values["featured_event"] = SerializerRegistry::getInstance()
                ->getSerializer($sponsor->getFeaturedEvent())
                ->serialize(
                  AbstractSerializer::filterExpandByPrefix($expand, $relation),
                  AbstractSerializer::filterFieldsByPrefix($fields, $relation),
                  AbstractSerializer::filterFieldsByPrefix($relations, $relation),
          ...
          case "lead_report_setting":
            ...
            $values["lead_report_setting"] = SerializerRegistry::getInstance()
              ->getSerializer($sponsor->getLeadReportSetting())
              ->serialize();
            break;
        }
      }
