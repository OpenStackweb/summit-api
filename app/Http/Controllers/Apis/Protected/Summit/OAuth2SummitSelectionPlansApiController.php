...
final class OAuth2SummitSelectionPlansApiController extends OAuth2ProtectedController {
  ...
  public function updateSelectionPlan($summit_id, $selection_plan_id) {
    return $this->processRequest(function () use ($summit_id, $selection_plan_id) {
      ...
      $selection_plan = $this->selection_plan_service->updateSelectionPlan(
        $summit,
        intval($selection_plan_id),
        HTMLCleaner::cleanData($payload, ["submission_period_disclaimer"]),
      );
  ...
  public function addSelectionPlan($summit_id) {
    return $this->processRequest(function () use ($summit_id) {
      ...
      $selection_plan = $this->selection_plan_service->addSelectionPlan(
        $summit,
        HTMLCleaner::cleanData($payload, ["submission_period_disclaimer"]),
      );
  ...
  public function addTrackGroupToSelectionPlan($summit_id, $selection_plan_id, $track_group_id) {
    return $this->processRequest(function () use ($summit_id, $selection_plan_id, $track_group_id) {
      ...
      $this->selection_plan_service->addTrackGroupToSelectionPlan(
        $summit,
        intval($selection_plan_id),
        intval($track_group_id),
      );
  ...
  public function deleteTrackGroupToSelectionPlan($summit_id, $selection_plan_id, $track_group_id) {
    return $this->processRequest(function () use ($summit_id, $selection_plan_id, $track_group_id) {
      ...
      $this->selection_plan_service->deleteTrackGroupToSelectionPlan(
        $summit,
        intval($selection_plan_id),
        intval($track_group_id),
      );
    ...
    return $this->_getAll(
      ...
      function () {
        return [
          ...
          "track_chairs_status" =>
            "sometimes|string|in:voted,untouched,team_selected,selected,maybe,pass",
      ...
      function ($filter) use ($summit, $selection_plan_id) {
        if ($filter instanceof Filter) {
          ...
          $filter->addFilterCondition(
            FilterElement::makeEqual("selection_plan_id", $selection_plan_id),
          );
          $current_member = $this->resource_server_context->getCurrentUser(false);
          if (!is_null($current_member)) {
            $filter->addFilterCondition(
              FilterElement::makeEqual("current_member_id", $current_member->getId()),
            );
          }
        }
        return $filter;
  ...
  public function getSelectionPlanPresentation($summit_id, $selection_plan_id, $presentation_id) {
    return $this->processRequest(function () use (
      ...
      return $this->ok(
        SerializerRegistry::getInstance()
          ->getSerializer($presentation, IPresentationSerializerTypes::TrackChairs)
          ->serialize(
            SerializerUtils::getExpand(),
            SerializerUtils::getFields(),
            SerializerUtils::getRelations(),
  ...
  public function getExtraQuestion($summit_id, $question_id) {
    return $this->processRequest(function () use ($summit_id, $question_id) {
      ...
      if (is_null($question)) {
        return $this->error404("Question not found.");
      }
  ...
  public function getExtraQuestionsMetadata($summit_id) {
    ...
    return $this->ok($this->selection_plan_extra_questions_repository->getQuestionsMetadata());
  }
  ...
  public function addExtraQuestion($summit_id) {
    ...
    return $this->_add(
      ...
      function ($payload, $summit) {
        return $this->selection_plan_extra_questions_service->addExtraQuestion(
          $summit,
  ...
  public function addExtraQuestionAndAssign($summit_id, $selection_plan_id) {
    ...
    return $this->_add(
      ...
      function ($payload, $selection_plan_id) {
        return $this->selection_plan_extra_questions_service->addExtraQuestionAndAssignTo(
          $selection_plan_id,
          HTMLCleaner::cleanData($payload, ["label"]),
        );
      },
  ...
  public function assignExtraQuestion($summit_id, $selection_plan_id, $question_id) {
    return $this->processRequest(function () use ($summit_id, $selection_plan_id, $question_id) {
      ...
      $assigment = $this->selection_plan_extra_questions_service->assignExtraQuestion(
        intval($selection_plan_id),
        intval($question_id),
      );
  ...
  public function deleteExtraQuestion($summit_id, $question_id) {
    ...
    return $this->_delete(
      intval($question_id),
      function ($question_id, $summit) {
        $this->selection_plan_extra_questions_service->deleteExtraQuestion(
          $summit,
          intval($question_id),
        );
      },
  ...
  public function removeExtraQuestion($summit_id, $selection_plan_id, $question_id) {
    ...
    return $this->_delete(
      intval($question_id),
      function ($question_id, $selection_plan_id) {
        $this->selection_plan_extra_questions_service->removeExtraQuestion(
          $selection_plan_id,
          intval($question_id),
        );
      },
   ...
   * @return \Illuminate\Http\JsonResponse
   */
  public function addExtraQuestionValueBySelectionPlan(
    $summit_id,
    $selection_plan_id,
    $question_id,
  ) {
   ...
   * @return \Illuminate\Http\JsonResponse|mixed
   */
  public function updateExtraQuestionValueBySelectionPlan(
    $summit_id,
    $selection_plan_id,
    $question_id,
    $value_id,
  ...
  public function deleteExtraQuestionValue($summit_id, $question_id, $value_id) {
    ...
    return $this->_delete(
      $value_id,
      function ($value_id, $summit, $question_id) {
        $this->selection_plan_extra_questions_service->deleteExtraQuestionValue(
          $summit,
          intval($question_id),
          intval($value_id),
        );
   ...
   * @return \Illuminate\Http\JsonResponse|mixed
   */
  public function deleteExtraQuestionValueBySelectionPlan(
    $summit_id,
    $selection_plan_id,
    $question_id,
    $value_id,
  ...
  public function attachEventType($id, $selection_plan_id, $event_type_id) {
    return $this->processRequest(function () use ($id, $selection_plan_id, $event_type_id) {
      ...
      $this->selection_plan_service->attachEventTypeToSelectionPlan(
        $summit,
        intval($selection_plan_id),
  ...
  public function detachEventType($id, $selection_plan_id, $event_type_id) {
    return $this->processRequest(function () use ($id, $selection_plan_id, $event_type_id) {
      ...
      $this->selection_plan_service->detachEventTypeFromSelectionPlan(
        $summit,
        intval($selection_plan_id),
        intval($event_type_id),
      );
  ...
  public function getAllowedPresentationActionType($summit_id, $selection_plan_id, $type_id) {
    return $this->processRequest(function () use ($summit_id, $selection_plan_id, $type_id) {
      ...
      $allowed_presentation_action_type = $selection_plan->getPresentationActionType(
        $presentation_action_type,
      );
      if (is_null($allowed_presentation_action_type)) {
        return $this->error404();
      }

      return $this->ok(
        SerializerRegistry::getInstance()
          ->getSerializer($allowed_presentation_action_type)
          ->serialize(
            SerializerUtils::getExpand(),
            SerializerUtils::getFields(),
            SerializerUtils::getRelations(),
  ...
  public function addAllowedPresentationActionType($id, $selection_plan_id, $type_id) {
    return $this->processRequest(function () use ($id, $selection_plan_id, $type_id) {
      ...
      $payload = $this->getJsonPayload(
        SummitSelectionPlanValidationRulesFactory::buildForAddPresentationActionType(),
      );
  ...
  public function updateAllowedPresentationActionType($id, $selection_plan_id, $type_id) {
    return $this->processRequest(function () use ($id, $selection_plan_id, $type_id) {
      ...
      $payload = $this->getJsonPayload(
        SummitSelectionPlanValidationRulesFactory::buildForUpdatePresentationActionType(),
      );
  ...
  public function removeAllowedPresentationActionType($id, $selection_plan_id, $type_id) {
    return $this->processRequest(function () use ($id, $selection_plan_id, $type_id) {
      ...
      $this->selection_plan_service->removeAllowedPresentationActionType(
        $summit,
        intval($selection_plan_id),
        intval($type_id),
      );
  ...
  public function addAllowedMember($id, $selection_plan_id) {
    return $this->processRequest(function () use ($id, $selection_plan_id) {
      ...
      $allowed_member = $this->selection_plan_service->addAllowedMember(
        $summit,
        intval($selection_plan_id),
        $payload["email"],
      );
  ...
  public function removeAllowedMember($id, $selection_plan_id, $allowed_member_id) {
    return $this->processRequest(function () use ($id, $selection_plan_id, $allowed_member_id) {
      ...
      $this->selection_plan_service->removeAllowedMember(
        $summit,
        intval($selection_plan_id),
        $allowed_member_id,
      );
  ...
  public function getMySelectionPlans($id) {
    return $this->processRequest(function () use ($id) {
      ...
      $filter->addFilterCondition(
        FilterParser::buildFilter("allowed_member_email", "==", $current_member->getEmail()),
      );
