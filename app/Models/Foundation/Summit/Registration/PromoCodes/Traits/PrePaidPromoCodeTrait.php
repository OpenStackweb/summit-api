...
trait PrePaidPromoCodeTrait {
   ...
   */
  public function getNextAvailableTicketPerType(
  ...
  public function getQuantityUsed(): int {
    ...
    Log::debug(
      sprintf(
        "PrePaidPromoCodeTrait::getQuantityUsed promo_code %s quantityUsed %s",
        $this->getCode(),
        $res,
      ),
    );
  ...
  public function getQuantityAvailable(): int {
    ...
    Log::debug(
      sprintf(
        "PrePaidPromoCodeTrait::getQuantityAvailable promo_code %s quantityAvailable %s",
        $this->getCode(),
        $res,
      ),
    );
