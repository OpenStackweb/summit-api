 ...
 */
#[OA\Tag(name: "Track Tag Groups", description: "Track Tag Groups Management Endpoints")]
final class OAuth2SummitTrackTagGroupsApiController extends OAuth2ProtectedController
{
    ...
    #[OA\Get(
        path: "/api/v1/summits/{id}/track-tag-groups/allowed-tags",
        operationId: "getAllowedTags",
        description: "Get all allowed tags for track tag groups in a summit",
        tags: ["Track Tag Groups"],
        parameters: [
            new OA\Parameter(
                name: "id",
    ...
    #[OA\Post(
        ...
        description: "Create a new track tag group",
        tags: ["Track Tag Groups"],
        parameters: [
            new OA\Parameter(
                name: "id",
    ...
    #[OA\Get(
        ...
        description: "Get a specific track tag group",
        tags: ["Track Tag Groups"],
        parameters: [
            new OA\Parameter(
                name: "id",
    ...
    #[OA\Put(
        ...
        description: "Update an existing track tag group",
        tags: ["Track Tag Groups"],
        parameters: [
            new OA\Parameter(
                name: "id",
    ...
    #[OA\Delete(
        ...
        description: "Delete a track tag group",
        tags: ["Track Tag Groups"],
        parameters: [
            new OA\Parameter(
                name: "id",
    ...
    #[OA\Post(
        path: "/api/v1/summits/{id}/track-tag-groups/seed",
        operationId: "seedDefaultTrackTagGroups",
        description: "Seed default track tag groups for a summit",
        tags: ["Track Tag Groups"],
        parameters: [
            new OA\Parameter(
                name: "id",
    ...
    #[OA\Post(
        path: "/api/v1/summits/{id}/tags/{tag_id}/seed-all-tracks",
        operationId: "seedTagOnAllTracks",
        description: "Seed a tag on all tracks in a summit",
        tags: ["Track Tag Groups"],
        parameters: [
            new OA\Parameter(
                name: "id",
    ...
    #[OA\Post(
        path: "/api/v1/summits/{id}/track-tag-groups/{track_tag_group_id}/seed-track/{track_id}",
        operationId: "seedTagTrackGroupOnTrack",
        description: "Seed a track tag group on a specific track",
        tags: ["Track Tag Groups"],
        parameters: [
            new OA\Parameter(
                name: "id",
