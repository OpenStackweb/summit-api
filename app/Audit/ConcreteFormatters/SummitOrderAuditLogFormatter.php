        ...
        try {
            ...
            switch ($this->event_type) {
                ...
                case IAuditStrategy::EVENT_ENTITY_UPDATE:
                    return $this->formatUpdateMessage($change_set, fn($details) => sprintf("Order '%s' (%s) in Summit '%s' updated: %s by user %s", $order_number, $id, $summit_name, $details, $this->getUserInfo()));
