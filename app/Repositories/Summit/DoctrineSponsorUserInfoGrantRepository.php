 ...
 */
final class DoctrineSponsorUserInfoGrantRepository extends SilverStripeDoctrineRepository implements
  ...
  protected function getFilterMappings() {
    return [
      ...
      "attendee_first_name" => ["m.first_name :operator :value", "o.first_name :operator :value"],
      "attendee_last_name" => ["m.last_name :operator :value", "o.surname :operator :value"],
      "attendee_full_name" => [
        "concat(m.first_name, ' ', m.last_name) :operator :value",
        "concat(o.first_name, ' ', o.surname) :operator :value",
      ],
      "attendee_email" => ["m.email :operator :value", "o.email :operator :value"],
