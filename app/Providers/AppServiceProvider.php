...
class AppServiceProvider extends ServiceProvider {
  ...
  static $summit_schedule_config_filter_dto_fields = ["type", "label", "is_enabled"];
  static $summit_schedule_config_filter_dto_validation_rules = [
    "label" => "sometimes|string|max:50",
    "is_enabled" => "required|boolean",
    "type" =>
      "required|string|in:DATE,TRACK,TAGS,TRACK_GROUPS,COMPANY,LEVEL,SPEAKERS,VENUES,EVENT_TYPES,TITLE,CUSTOM_ORDER,ABSTRACT",
  ];
  static $summit_schedule_config_pre_filter_dto_fields = ["type", "values"];
  ...
  static $extra_question_dto_fields = ["question_id", "answer"];
  ...
  static $event_dto_fields_publish = ["id", "start_date", "end_date", "duration", "location_id"];
  ...
  static $rsvp_answer_dto_fields = ["question_id", "value"];
  ...
  public function boot() {
    ...
    Validator::extend("int_array", function ($attribute, $value, $parameters, $validator) {
      $validator->addReplacer("int_array", function ($message, $attribute, $rule, $parameters) use (
        $validator,
      ) {
    ...
    Validator::extend("emails_array", function ($attribute, $value, $parameters, $validator) {
      $validator->addReplacer("emails_array", function (
        $message,
        $attribute,
        $rule,
        $parameters,
    ...
    Validator::extend("int_or_string_array", function (
      $attribute,
      $value,
      $parameters,
      $validator,
    ) {
      $validator->addReplacer("int_or_string_array", function (
        $message,
        $attribute,
        $rule,
        $parameters,
    ...
    Validator::extend("event_dto_array", function ($attribute, $value, $parameters, $validator) {
      $validator->addReplacer("event_dto_array", function (
        $message,
        $attribute,
        $rule,
        $parameters,
      ...
      foreach ($value as $element) {
        ...
        if ($validation->fails()) {
          Log::debug(
            sprintf(
              "event_dto_array::validation fails %s",
    ...
    Validator::extend("extra_question_dto_array", function (
      $attribute,
      $value,
      $parameters,
      $validator,
    ) {
      $validator->addReplacer("extra_question_dto_array", function (
        $message,
        $attribute,
        $rule,
        $parameters,
    ...
    Validator::extend("summit_schedule_config_filter_dto_array", function (
      $attribute,
      $value,
      $parameters,
      $validator,
    ) {
      $validator->addReplacer("summit_schedule_config_filter_dto_array", function (
        $message,
        $attribute,
        $rule,
        $parameters,
      ) use ($validator) {
        return sprintf("%s should be an array of schedule config filter data", $attribute);
      });
      if (!is_array($value)) {
        return false;
      }
      foreach ($value as $element) {
        ...
        $validation = Validator::make(
          $element,
          self::$summit_schedule_config_filter_dto_validation_rules,
        );
    ...
    Validator::extend("summit_schedule_config_pre_filter_dto_array", function (
      $attribute,
      $value,
      $parameters,
      $validator,
    ) {
      $validator->addReplacer("summit_schedule_config_pre_filter_dto_array", function (
        $message,
        $attribute,
        $rule,
        $parameters,
      ) use ($validator) {
        return sprintf("%s should be an array of schedule config pre filter data", $attribute);
      });
      if (!is_array($value)) {
        return false;
      }
      foreach ($value as $element) {
        ...
        $validation = Validator::make(
          $element,
          self::$summit_schedule_config_pre_filter_dto_validation_rules,
        );
    ...
    Validator::extend("ticket_dto_array", function ($attribute, $value, $parameters, $validator) {
      $validator->addReplacer("ticket_dto_array", function (
        $message,
        $attribute,
        $rule,
        $parameters,
    ...
    Validator::extend("event_dto_publish_array", function (
      $attribute,
      $value,
      $parameters,
      $validator,
    ) {
      $validator->addReplacer("event_dto_publish_array", function (
        $message,
        $attribute,
        $rule,
        $parameters,
    ...
    Validator::extend("lead_report_settings_dto_array", function (
      $attribute,
      $value,
      $parameters,
      $validator,
    ) {
      $validator->addReplacer("lead_report_settings_dto_array", function (
        $message,
        $attribute,
        $rule,
        $parameters,
      ...
      foreach ($value as $element) {
        ...
        foreach ($element as $key => $element_val) {
          ...
          $validation = Validator::make(
            $element_val,
            self::$lead_report_settings_question_dto_validation_rules,
          );
    ...
    Validator::extend("text", function ($attribute, $value, $parameters, $validator) {
      $validator->addReplacer("text", function ($message, $attribute, $rule, $parameters) use (
        $validator,
      ) {
    ...
    Validator::extend("string_array", function ($attribute, $value, $parameters, $validator) {
      $validator->addReplacer("string_array", function (
        $message,
        $attribute,
        $rule,
        $parameters,
    ...
    Validator::extend("string_or_string_array", function (
      $attribute,
      $value,
      $parameters,
      $validator,
    ) {
      $validator->addReplacer("string_or_string_array", function (
        $message,
        $attribute,
        $rule,
        $parameters,
    ...
    Validator::extend("url_array", function ($attribute, $value, $parameters, $validator) {
      $validator->addReplacer("url_array", function ($message, $attribute, $rule, $parameters) use (
        $validator,
      ) {
    ...
    Validator::extend("entity_value_array", function ($attribute, $value, $parameters, $validator) {
      $validator->addReplacer("entity_value_array", function (
        $message,
        $attribute,
        $rule,
        $parameters,
    ...
    Validator::extend("link_array", function ($attribute, $value, $parameters, $validator) {
      $validator->addReplacer("link_array", function (
        $message,
        $attribute,
        $rule,
        $parameters,
    ...
    Validator::extend("team_permission", function ($attribute, $value, $parameters, $validator) {
      $validator->addReplacer("team_permission", function (
        $message,
        $attribute,
        $rule,
        $parameters,
      ...
      return in_array($value, [
        ChatTeamPermission::Read,
        ChatTeamPermission::Write,
        ChatTeamPermission::Admin,
      ]);
    });

    Validator::extend("chat_message_priority", function (
      $attribute,
      $value,
      $parameters,
      $validator,
    ) {
      $validator->addReplacer("chat_message_priority", function (
        $message,
        $attribute,
        $rule,
        $parameters,
      ...
      return in_array($value, [
        PushNotificationMessagePriority::Normal,
        PushNotificationMessagePriority::High,
      ]);
    });

    Validator::extend("after_or_null_epoch", function (
      $attribute,
      $value,
      $parameters,
      $validator,
    ) {
      $validator->addReplacer("after_or_null_epoch", function (
        $message,
        $attribute,
        $rule,
        $parameters,
    ...
    Validator::extend("greater_than_field", function ($attribute, $value, $parameters, $validator) {
      $validator->addReplacer("greater_than_field", function (
        $message,
        $attribute,
        $rule,
        $parameters,
    ...
    Validator::extend("valid_epoch", function ($attribute, $value, $parameters, $validator) {
      $validator->addReplacer("valid_epoch", function (
        $message,
        $attribute,
        $rule,
        $parameters,
    ...
    Validator::extend("hex_color", function ($attribute, $value, $parameters, $validator) {
      $validator->addReplacer("hex_color", function ($message, $attribute, $rule, $parameters) use (
        $validator,
      ) {
    ...
    Validator::extend("geo_latitude", function ($attribute, $value, $parameters, $validator) {
      $validator->addReplacer("geo_latitude", function (
        $message,
        $attribute,
        $rule,
        $parameters,
    ...
    Validator::extend("geo_longitude", function ($attribute, $value, $parameters, $validator) {
      $validator->addReplacer("geo_longitude", function (
        $message,
        $attribute,
        $rule,
        $parameters,
    ...
    Validator::extend("country_iso_alpha2_code", function (
      $attribute,
      $value,
      $parameters,
      $validator,
    ) {
      $validator->addReplacer("country_iso_alpha2_code", function (
        $message,
        $attribute,
        $rule,
        $parameters,
    ...
    Validator::extend("currency_iso", function ($attribute, $value, $parameters, $validator) {
      $validator->addReplacer("currency_iso", function (
        $message,
        $attribute,
        $rule,
        $parameters,
    ...
    Validator::extend("rsvp_answer_dto_array", function (
      $attribute,
      $value,
      $parameters,
      $validator,
    ) {
      $validator->addReplacer("rsvp_answer_dto_array", function (
        $message,
        $attribute,
        $rule,
        $parameters,
    ...
    Validator::extend("megabyte_aligned", function ($attribute, $value, $parameters, $validator) {
      $validator->addReplacer("megabyte_aligned", function (
        $message,
        $attribute,
        $rule,
        $parameters,
    ...
    Validator::extend("single_word", function ($attribute, $value, $parameters, $validator) {
      $validator->addReplacer("single_word", function (
        $message,
        $attribute,
        $rule,
        $parameters,
  ...
  public function register() {
    ...
    App::singleton(
      "App\Models\ResourceServer\IAccessTokenService",
      "App\Models\ResourceServer\AccessTokenService",
    );
    App::singleton("App\Models\ResourceServer\IApi", 'models\\resource_server\\Api');
    App::singleton(
      "App\Models\ResourceServer\IApiEndpoint",
      'models\\resource_server\\ApiEndpoint',
    );
