...
/**
 * Class Version20190918111958
 * @package Database\Migrations\Model
 */
class Version20190918111958 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        if ($builder->hasTable("SummitTicketType") && !$builder->hasColumn("SummitTicketType", "BadgeTypeID")) {
