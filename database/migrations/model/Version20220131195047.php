...
/**
 * Class Version20220131195047
 * @package Database\Migrations\Model
 */
class Version20220131195047 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema): void
    {
        ...
        if (!$builder->hasTable("PresentationAttendeeVote")) {
            $builder->create("PresentationAttendeeVote", function (Table $table) {
                ...
                $table->unique(['PresentationID', 'SummitAttendeeID']);
            });
        }
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $builder->dropIfExists("PresentationAttendeeVote");
    }
}
