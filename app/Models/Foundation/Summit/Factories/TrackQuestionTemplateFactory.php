...
final class TrackQuestionTemplateFactory {
  ...
  public static function build(array $data) {
    ...
    switch ($data["class_name"]) {
      case TrackTextBoxQuestionTemplate::ClassName:
        $track_question_template = self::populateTrackSingleValueTemplateQuestion(
          new TrackTextBoxQuestionTemplate(),
          $data,
        );
        break;
      case TrackCheckBoxQuestionTemplate::ClassName:
        $track_question_template = self::populateTrackSingleValueTemplateQuestion(
          new TrackCheckBoxQuestionTemplate(),
          $data,
        );
        break;
      case TrackCheckBoxListQuestionTemplate::ClassName:
        $track_question_template = self::populateTrackMultiValueQuestionTemplate(
          new TrackCheckBoxListQuestionTemplate(),
          $data,
        );
        break;
      case TrackRadioButtonListQuestionTemplate::ClassName:
        $track_question_template = self::populateTrackMultiValueQuestionTemplate(
          new TrackRadioButtonListQuestionTemplate(),
          $data,
        );
        break;
      case TrackDropDownQuestionTemplate::ClassName:
        $track_question_template = self::populateTrackDropDownQuestionTemplate(
          new TrackDropDownQuestionTemplate(),
          $data,
        );
        break;
      case TrackLiteralContentQuestionTemplate::ClassName:
        $track_question_template = self::populateTrackLiteralContentQuestionTemplate(
          new TrackLiteralContentQuestionTemplate(),
          $data,
        );
        break;
    }
   ...
   */
  private static function populateTrackSingleValueTemplateQuestion(
    TrackSingleValueTemplateQuestion $question,
    array $data,
  ) {
   ...
   * @return TrackQuestionTemplate
   */
  private static function populateTrackMultiValueQuestionTemplate(
    TrackMultiValueQuestionTemplate $question,
    array $data,
  ) {
   ...
   * @return TrackQuestionTemplate
   */
  private static function populateTrackQuestionTemplate(
    TrackQuestionTemplate $question,
    array $data,
  ) {
    if (isset($data["name"])) {
   ...
   * @return TrackQuestionTemplate
   */
  private static function populateTrackDropDownQuestionTemplate(
    TrackDropDownQuestionTemplate $question,
    array $data,
  ) {
   ...
   * @return TrackQuestionTemplate
   */
  private static function populateTrackLiteralContentQuestionTemplate(
    TrackLiteralContentQuestionTemplate $question,
    array $data,
  ) {
