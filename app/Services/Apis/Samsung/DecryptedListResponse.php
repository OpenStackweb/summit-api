 ...
 */
final class DecryptedListResponse extends AbstractPayload implements
  ...
  public function __construct(string $key, string $content, array $params = []) {
    ...
    if ($dec->hasError()) {
      Log::warning(
        sprintf("DecryptedListResponse::constructor error %s.", $dec->getErrorMessage()),
      );
  ...
  public function current() {
    return SamsungRecordSerializer::serialize($this->payload[$this->position], $this->params);
  }
