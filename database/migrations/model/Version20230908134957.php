...
/**
 * Class Version20230908134957
 * @package Database\Migrations\Model
 */
final class Version20230908134957 extends AbstractMigration
{
    use CreateTableTrait;

    const TableName = 'SummitRegistrationFeedMetadata';
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema): void
    {
        self::createTable($schema, self::TableName, function(Table $table){
            $table->string('Key')->setNotnull(true);
            ...
            // IDX
            $table->unique(['Key', 'SummitID'], 'SummitRegistrationFeedMetadata_IDX_KEY_SUMMIT_ID');
        });
    }
