...
final class OAuth2SummitTicketsApiTest extends ProtectedApiTestCase {
  ...
  public function testRefundTicketWithNote() {
    ...
    $params = [
      ...
      "ticket_id" => $ticket->getId(),
      "expand" =>
        "order,refund_requests,refund_requests.requested_by,refund_requests.ticket,refund_requests.ticket.ticket_type,refund_requests.ticket.refund_requests,refund_requests.refunded_taxes",
    ];
