...
class DoctrineSummitRegistrationPromoCodeRepository
  ...
  protected function applyExtraJoins(QueryBuilder $query, ?Filter $filter = null) {
    if (!is_null($filter)) {
      ...
      if ($filter->hasFilter("owner") || $filter->hasFilter("owner_email")) {
        $query = $query->leftJoin("mpc.owner", "owr")->leftJoin("mdc.owner", "owr2");
      }
      ...
      if ($filter->hasFilter("sponsor")) {
        $query = $query->leftJoin("spc.sponsor", "spnr")->leftJoin("spdc.sponsor", "spnr2");
      }
    }
  ...
  protected function getFilterMappings(): array {
    ...
    $res = [
      ...
      "class_name" => new DoctrineInstanceOfFilterMapping("pc", [
        ...
        MemberSummitRegistrationDiscountCode::ClassName =>
          MemberSummitRegistrationDiscountCode::class,
        SpeakerSummitRegistrationDiscountCode::ClassName =>
          SpeakerSummitRegistrationDiscountCode::class,
        SponsorSummitRegistrationDiscountCode::ClassName =>
          SponsorSummitRegistrationDiscountCode::class,
        SpeakersSummitRegistrationPromoCode::ClassName =>
          SpeakersSummitRegistrationPromoCode::class,
        ...
        PrePaidSummitRegistrationDiscountCode::ClassName =>
          PrePaidSummitRegistrationDiscountCode::class,
      ]),
    ];
    ...
    if ($filter instanceof Filter) {
      ...
      if ($filter->hasFilter("owner_email")) {
        $res["owner_email"] = new DoctrineFilterMapping(
          "(owr.email :operator :value) " . "OR (owr2.email :operator :value) ",
        );
      }
      ...
      if ($filter->hasFilter("tag")) {
        $res["tag"] = new DoctrineLeftJoinFilterMapping("pc.tags", "t", "t.tag :operator :value");
      }

      if ($filter->hasFilter("tag_id")) {
        $res["tag_id"] = new DoctrineLeftJoinFilterMapping("pc.tags", "t", "t.id :operator :value");
      }
    }
  ...
  public function getIdsBySummit(
    ...
    if ($filter instanceof Filter) {
      $where_conditions = $filter->toRawSQL([
        ...
        "tag" => "t.Tag",
        "tag_id" => "t.ID",
        "class_name" => new SQLInstanceOfFilterMapping("pc", [
          SummitRegistrationPromoCode::ClassName => SummitRegistrationPromoCode::class,
          SummitRegistrationDiscountCode::ClassName => SummitRegistrationDiscountCode::class,
          MemberSummitRegistrationPromoCode::ClassName => MemberSummitRegistrationPromoCode::class,
          SpeakerSummitRegistrationPromoCode::ClassName =>
            SpeakerSummitRegistrationPromoCode::class,
          SponsorSummitRegistrationPromoCode::ClassName =>
            SponsorSummitRegistrationPromoCode::class,
          MemberSummitRegistrationDiscountCode::ClassName =>
            MemberSummitRegistrationDiscountCode::class,
          SpeakerSummitRegistrationDiscountCode::ClassName =>
            SpeakerSummitRegistrationDiscountCode::class,
          ...
          PrePaidSummitRegistrationPromoCode::ClassName =>
            PrePaidSummitRegistrationPromoCode::class,
          PrePaidSummitRegistrationDiscountCode::ClassName =>
            PrePaidSummitRegistrationDiscountCode::class,
        ]),
        "type" => [
        ...
        "sponsor_company_name" => ["spn1.Name :operator :value", "spn2.Name :operator :value"],
        "sponsor_id" => ["sp1.Id :operator :value", "sp2.Id :operator :value"],
        "contact_email" => [
          "spnpc.ContactEmail :operator :value",
          "spndc.ContactEmail :operator :value",
        ],
        "tier_name" => ["sp1stt.Name :operator :value", "sp2stt.Name :operator :value"],
      ]);
